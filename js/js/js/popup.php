...
<div class="modal" id="guest_name" role="dialog" >
    <div class="modal-dialog">
	     <div class="modal-content">
	        <div class="modal-body" style="padding: 0;">
	        	<i class="back_close " data-dismiss="modal">&#10006</i>
	...
	<div class="modal fade" id="popupdriverservice" role="dialog">
    	<div class="modal-dialog">
      		<div class="modal-content">
        		<div class="modal-body" style="padding: 0">
        			<i class="back_close " ng-click="cancel()" data-dismiss="modal">&#10006</i>
        			<div style="font-size: 18px;padding: 10px;background-color: #fff;    border-radius: 8px 8px 0 0;" align="center" ng-if="state6[0].status_confirm !=0">
        			<input type="hidden" name="vcidinfo" value="{{vdIDclickinfo}}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 0">
        ...
        <input type="hidden" name="vccomment" value="{{vccomment}}">
            ...
            <div class="" ng-if="getcommentviewhome.length == 0" style="padding: 3px 6px; border-radius: 8px; background: #fff;">    
            <div class="borderdetail-check">
             ...
             <div class="box-com-se">                    
                       <div style="font-size: 16px;"> 
                        <div class="btn btn-block btn-default" ng-click="updatecomment(vccomment)" ng-style="senddata" style="margin-top: 19px; padding: 12px !important;    display: block; background: #3b5998; color: #fff;" ng-if="getcommentviewhome.length == 0" data-dismiss="modal">
                            <i class="fa fa-paper-plane fa-lg " aria-hidden="true"></i>
                        </div>
						...
						<div class="box-in-comment" ng-repeat="item in getcommentviewhome" style="font-size: 16px;    padding-top: 7px;" ng-if="getcommentviewhome.length != 0">
...
<div style="font-size: 18px; padding: 10px; background: #fff;  position: fixed; width: 100%; z-index: 1200;" align="center">
	<div ng-if="flagcheck == 1"  >This order details</div>
		        <div ng-if="flagcheck == 2"  >ข้อมูลการจองนี้</div>
		        <div ng-if="flagcheck == 3"  >这订单详情</div>
	<i class="back_close " ng-click="cancel()" data-dismiss="modal" style="position: fixed; right: 0;top: 6px;">&#10006</i>	
	            </div>
    <div class="modal-dialog" style="margin: 0;margin-top: 30px">
	                ...
	                <table style="font-size: 16px" width="100%" ng-if="typeTour != 'transfer'" ng-repeat="item in dataVoucher">
	                    ...
	                    <tr >
	                      ...
	                      <td style="padding: 10px 0">
	                          ...
	                          <span ng-if="flagcheck == 2">กลับไปยังสถาน :</span>
	                    ...
	                    <tr>
	                      ...
	                      <td >
	                          <span >
	                            <i  class="fa fa-user " aria-hidden="true" style="margin-right: 10px;color: #3b5998;font-size: 20px;"></i>{{item.posted}} 
	                        </span>
...
<!-- CHAT SERVICE -->
<!-- ************************** -->
<div class="modal fade" id="stylepoupmyinfo" role="dialog" tabindex="-1" data-focus-on="input:first">
	...
	<div style="font-size: 18px; padding: 10px; background: #fff;  position: fixed; width: 100%;z-index: 
	1200" align="center" align="center">
	        ...
	        <div class="modal-body" >
	        	<div style="padding: 3px 2px; background: #fff; border-radius: 8px;">
			            <table style="font-size: 16px;" cellspacing="0" cellpadding="0" width="100%">
			                ...
			                <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-click="agent_guest_name(1)" data-toggle="modal" href="#guest_name" data-target="#guest_name">
