...
<table  style="width:100% " >
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_checkguest_<?=$arr[project][id];?>_1">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_checkguest_<?=$arr[project][id];?>_1"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_checkguest_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
			...
			<div class="input-group" style="margin-top:10px; ">
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_checkguest_<?=$arr[project][id];?>_2">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_checkguest_<?=$arr[project][id];?>_2"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#driver_remark_noguest_<?=$arr[project][id];?>').addClass("tab_alert");
	...
	<tr>
		<td><div class="topictransfer">รูปภาพประกอบ (ถ้ามี)</div> 
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_noguest_<?=$arr[project][id];?>_1">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_1"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_noguest_<?=$arr[project][id];?>_2">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_2"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_2').css({"background": "#fa1431","color": "#333333", });
			...
			<div class="input-group" style="margin-top:10px; ">
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_noguest_<?=$arr[project][id];?>_3">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_3"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_3').css({"background": "#fa1431","color": "#333333", });
			...
			<div class="input-group" style="margin-top:10px; ">
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_noguest_<?=$arr[project][id];?>_4">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_4"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
<div    class="modal fade" id="popup_topoint_<?=$arr[project][id];?>" role="dialog"   aria-labelledby="myModalLabel"    >
  <?  include ("load/page/back_popup.php");?>
 <div class="modal-dialog" style="margin-top:-100px; position: relative; "  >
          ...
          <tr>
            <td class="gay5"><div class="topictransfer">ถ่ายสถานที่รับแขก (ถ้ามี)</div>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_topoint_<?=$arr[project][id];?>_1">
          &nbsp;
...
$('#url_photo_topoint_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_topoint_<?=$arr[project][id];?>_2">
          &nbsp;
...
$('#url_photo_topoint_<?=$arr[project][id];?>_2').css({"background": "#fa1431","color": "#333333", });
				...
				<div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_topoint_<?=$arr[project][id];?>_3">
          &nbsp;
...
<div class="modal fade" id="popup_complete_<?=$arr[project][id];?>" role="dialog"   aria-labelledby="myModalLabel"    >
 ...
 <div class="modal-dialog"  >
   ...
   <!-- Modal  class="modal fade" content-->
            <div class="modal-content"  > 
 			<div style="font-size:100px; color:#999999; padding-top:3px;"><center><i class="fa   fa-automobile"></i></center></div>
			<h4 class="modal-title" style="font-size:25px; height:15px;   font-family:Arial, Helvetica, sans-serif; text-transform:uppercase">
 					<center><b> คุณแน่ใจหรือไม่</b></center></h4>
          ...
          <tr>
            <td class="gay5"><div class="topictransfer">ถ่ายสถานที่ส่งแขก (ถ้ามี)</div>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_finishpoint_<?=$arr[project][id];?>_1">
&nbsp;
...
$('#url_photo_finishpoint_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_finishpoint_<?=$arr[project][id];?>_2">
&nbsp;
...
$('#url_photo_finishpoint_<?=$arr[project][id];?>_2').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" id="url_photo_finishpoint_<?=$arr[project][id];?>_3">
&nbsp;
