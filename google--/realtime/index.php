...
<script src="http://maps.google.com/maps/api/js?v=3.2&key=AIzaSyDJa08ZMaSnJP5A6EsL9wxqdDderh7zU90&sensor=false"></script>
...
<script type="text/javascript">
	...
	var customIcons = {
      free: {
        icon: 'images/2.png?v=1',
     shadow: 'http://labs.google.com/ridefinder/images/mm_20_shadow.png'
      },
      busy: {
        icon: 'images/1.png?v=1',
       shadow: 'http://labs.google.com/ridefinder/images/mm_20_shadow.png'
      }
    };
	...
	function initialize() {
		...
		var myLatlng = new google.maps.LatLng(7.903282992397491, 98.31220996091315);
		var myOptions = {
			zoom : 14,
			center : myLatlng,
	...
	function updateMaps() {
		...
		var data = 'datanew.xml?t=' + timestamp;
