...
$sql = "SELECT TB_transferproduct.* ,TB_order.invoice as TB_order_order,TB_order.orderid,TB_order.agent as TB_order_agent,TB_order.status as TB_order_status,TB_order.type as TB_order_type,TB_order.program as TB_order_program,TB_order.outdate as TB_order_outdate,TB_order.airout_h,TB_order.airout_m,TB_order.id as TB_order_id,TB_order.code as TB_order_code, TB_order.agent as TB_order_agent,TB_order.count_driver,TB_order.drivername ,TB_order.count_service,TB_order.count_op,TB_order.post_date,TB_order.airin_time as TB_order_air_time,TB_order.air as TB_order_air,TB_order.ondate as TB_order_ondate,TB_order.driver_topoint as TB_order_driver_topoint,TB_order.driver_pickup as TB_order_driver_pickup,TB_order.driver_complete as TB_order_driver_complete,TB_order.driver_topoint_date as TB_order_driver_topoint_date,TB_order.driver_pickup_date as TB_order_driver_pickup_date,TB_order.transfer_in, TB_order.driver_complete_date as TB_order_driver_complete_date,TB_order.room_number,TB_order.transfer_in,TB_order.sub_reject,TB_order.sub_confirm,TB_order.company,TB_order.admin_company,
...
LEFT JOIN web_transferplace_new as TB_transferplace_naviback ON TB_product.place = TB_transferplace_naviback.id*/
 ...
 WHERE TB_order.orderid  = '".$_POST[id]."' ORDER BY TB_order.outdate ASC";
$rows = array();
