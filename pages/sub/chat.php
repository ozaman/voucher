<div class="modal-dialog" style="margin:0">
    ...
    border-top-left-radius: 0;">	
    	<div class="modal-body" style="padding: 10px;padding-bottom: 0">
			...
			<!-- <input type="hidden" name="vc_{{VCID}}" id="vc_vcid"  value="{{VCID}}" > -->
	<!-- 		
 <script type="text/javascript">
  $(document).ready(function(){
     alert($('#VCID').val());
   $('#vcid').on('click',function(){
       alert($('#VCID').val());
  });
    //document.getElementById("vcid").addEventListener("click", myFunction);

   function myFunction(event){
          // alert(event)
          console.log(event)
            //alert(document.getElementById('VCID').value);
         }
 ...
 // 
  ...
  <style type="text/css">
    ...
    .menudriver{ /*or other element you want*/
                ...
                <table id="record" width="100%" style="font-size: 16px;border-color: none !important" >
                    <tr style="background-color: #ddd;">
                        ...
                        <td  width="40" style="border-radius: 0 8px 0 0;" align="center"> 
                         ...
                         <div ng-if="item.comment_from == 'customer'">
      <img src="images/icon/user/customer.png?v=<?=$cache;?>" width="30" style="display: inline-block; " >
				          </div>
									  
 
                         <div ng-if="item.comment_from == 'driver'">
      <img src="images/icon/user/driver.png?v=<?=$cache;?>" width="30" style="display: inline-block; " >
				          </div>
                    ...
                    <tr ng-if="item.state == 9" style="background: #f0f0f0;">
                        ...
                        <td  ></td>
                        <td colspan="5" style="padding: 8px 0;border-radius: 0 0 0 8px;">
                            <span ng-if="flagcheck == 1" >Waiting </span>
                            <span ng-if="flagcheck == 2">ฉันรออยู่แล้ว </span>
                            <span ng-if="flagcheck == 3">我已在等</span>
                        </td>
                    ...
                    <tr ng-if="item.state == 14 || item.state == 33" style="background: #f0f0f0;">
                    ...
                    <tr ng-if="item.state == 14 || item.state == 33" style="background: #f0f0f0;">
                     ...
                     <tr ng-if="item.state == 14 || item.state == 33" >
                    	<td colspan="8">
                    		<div class="locationmap" id="slocationdelaydriver{{item.id}}">
						<iframe id="iframes" ng-src="{{iframe.src2 | trusted}}"  style="width: 100%;    height: 100%; border:none "></iframe>
