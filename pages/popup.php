    ...
    <div class="modal-content">
      <div class="modal-body" style="padding: 0;">
			...
			<div align="center" class="box-in-photo" style="height: 450px; overflow: hidden; overflow-y: scroll;    overflow-x: scroll;width: 100%;padding: 5px">
				<div style="position: absolute; border: 1px solid #3b5998;border-radius: 8px; padding: 5px; text-decoration: none; left:  10px; margin-top: -40px;">
                ...
                <!-- <img src="{{dataimg}}.jpg" width="100%" height="100%"> -->
    ...
    <div class="modal-content">
      <div class="modal-body" style="padding: 0;">
			...
			<div align="center" class="box-in-photo" style=" width: 100%;padding: 5px">  		
                <img align="center" ng-src="images/logo/{{logoAgent}}.jpg" width="100%" height="100%" >
			</div>
      </div>
    </div>
  </div>
								...
								<tr>
									<td align="center" colspan="3">
    									...
    									<div style="width: 98%" align="center">
    													<img id="blah" />
    													<input type="hidden" value="{{data1}}" ng-model="data1" id="one" />
							...
							<table width="100%">
								...
								<tr>
                                    ...
                                    rotate: 0,
										...
										var url = "../vc/php/uploadimage.php";
           ...
           //                           $.ajax({
									  ...
									  // });
										...
										//var params = "lorem=ipsum&name=binny";
										 // $("#one").val(file);
										 // console.log(file)
										 http.open('POST', '../vc/php/uploadimage.php'+"?"+f, true);
                                         http.setRequestHeader("X-Requested-With", "XMLHttpRequest");
                                        http.setRequestHeader("pragma", "no-cache");
                                        //Upload progress
                                        http.upload.addEventListener("progress", function(e) {
...
<div class="modal fade" id="guest_name">
 ...
 <div class="modal fade" id="phone3" role="dialog">
    <div class="modal-dialog">
	     <div class="modal-content">
	        <div class="modal-body" style="padding: 0;">
	        	<i class="back_close " data-dismiss="modal">&#10006</i>
    ...
    <div class="modal-dialog">
	     <div class="modal-content">
	        <div class="modal-body" style="padding: 0;">
	        	<i class="back_close " data-dismiss="modal">&#10006</i>
	        	<div align="center" style="font-size: 18px;    padding: 5px;">
					<span> <img src="images/localphone.png" width="35"> = ? </span>
				</div>
				<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 15px;    border-radius: 0 0 10px 10px;" align="center">
					<span> <img src="images/localphone.png" width="35"> = 
...
<div id="Ephone3" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-body" style="padding: 0">
		    <i class="back_close " ng-click="cancelEphone1()" data-dismiss="modal">&#10006</i> 
		    	...
		    	<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 15px;    border-radius: 0 0 10px 10px;" align="center">
						...
						<div class="" id="group" >                                        
							...
							<div id="select-country" class="form-control"  ng-click="Country3()" style="margin-bottom: 25px !important;">
								<span ><img src="iconstatus/flag/test_f/{{imgcoutry3}}.png" width="22"></span>{{Countryfont3}}
							</div>
							<div class="countrybox3" ng-style="countrybox3">
								<ul class="cu-name" >
									<li ng-repeat="i in country" ng-click="numCountryselect3(i,$event)" ng-class="{even: $even, odd: $odd}">
										<span><img src="iconstatus/flag/test_f/{{i.country_code}}.png" width="25"></span>
										<div ng-if="flagcheck == 1" style="display: inline-block;"><p style="margin:0;display: inline-block;width: 80px;">(+{{i.phonecode}})</p><span id="name-cu">{{i.name_en}}</span></div>
										<div ng-if="flagcheck == 2" style="display: inline-block;"><p style="margin:0;display: inline-block;width: 80px;">(+{{i.phonecode}})</p><span id="name-cu">{{i.name_th}}</span></div>
										<div ng-if="flagcheck == 3" style="display: inline-block;"><p style="margin:0;display: inline-block;width: 80px;">(+{{i.phonecode}})</p><span id="name-cu">{{i.name_cn}}</span></div>
						...
						<div style="padding: 0">
							<div ng-click="Country3()" class="form-control" ng-model="selectcountryValue3" id="labelcun" style="width: 30%; display: inline-block;float: left; " ><span><img src="iconstatus/flag/test_f/{{imgcoutry3}}.png" width="22" style="margin-right: 5px"></span>{{tcountryValue3}}
							</div>

							<div style="width: 67%; float: right; margin-bottom: 20px; display: inline-block;">
								<input type="tel" class="form-control" id="phonere" ng-model="ephonenew2" value="{{ephonenew2}}" ng-change="Ephone3(ephonenew2)" />
      	...
      	<div class="modal-content">
	        <div class="modal-body" style="padding: 0">
				...
				<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 15px;    border-radius: 0 0 8px 8px;" align="center">
						...
						<p class="textdetail" style="width: 100%;">
							<input type="email" class="form-control" value="{{agent_email2}}" ng-model="agent_email2" ng-change="functionemail2null(agent_email2)" style="    height: 50px;" placeholder="example@example.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" / required>
						</p>
...
<div class="modal fade" id="editsocialall" role="dialog">
 ...
 <div class="modal fade" id="editsocialallnull" role="dialog">
    <div class="modal-dialog">
      	<div class="modal-content">
	        <div class="modal-body" style="padding: 0;">
           		<i class="back_close " ng-click="canceleditsocialall()" data-dismiss="modal">&#10006</i>
				...
				<div class="Edit1"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{idwechatnull}}.jpg" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullwechat}}" ng-model="nullwechat" ng-change="wechatnull(nullwechat)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
								<td width="4%"></td>
								<td colspan="3" width="92%" align="center" >
									<div class="btn-saveso"  ng-click="update_social_bookAgentNULL()" style=" margin-top: 15px; padding: 11px;text-align: center;" data-dismiss="modal">
										<span class="fa fa-save "  aria-hidden="true" align="center" style="font-size: 20px;    text-align: center;" ></span>
										<span ng-if="flagcheck == 1">Save</span>
										<span ng-if="flagcheck == 2">บันทึก</span>
										<span ng-if="flagcheck == 3">保存</span>
					...
					<div  class="Edit2"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{idlinenull}}.jpg" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullline}}" ng-model="nullline" ng-change="linenull(nullline)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div class="Edit3"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconzellonull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullzello}}" ng-model="nullzello" ng-change="zellonull(nullzello)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div class="Edit44" style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconqqnull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullqq}}" ng-model="nullqq" ng-change="qqnull(nullqq)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div class="Edit5"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconwangnull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullwang}}" ng-model="nullwang" ng-change="wangnull(nullwang)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div  class="Edit6"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconskypenull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullskype}}" ng-model="nullskype" ng-change="skypenull(nullskype)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div  class="Edit7"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconwhatnull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullwhat}}" ng-model="nullwhat" ng-change="whatnull(nullwhat)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
					...
					<div class="Edit8"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconfacenull}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
									<input type="text" class="form-control" value="{{nullface}}" ng-model="nullface" ng-change="facenull(nullface)" style="height: 50px">
								</td>
								<td width="4%"></td>
							</tr>
							<tr>
											...
											<tr>  
												<td colspan="5">
													<div style="padding: 0 5px">
														<div ng-click="detailfirsthome(vdIDclickinfo)" data-toggle="modal" data-target="#" >
    	...
    	<div class="modal-content">      
      		<div class="modal-body" style="padding: 0">
				...
				<div style="font-size: 16px; padding: 10px; background: #fff;  width: 100%;z-index: 1200;" align="center" align="center">
					...
					<div style="margin: 3px; padding-bottom: 10px; border-bottom: 1px solid #3b5998;padding-top: 10px;">
						<span ng-if="flagcheck == 1" ng-bind="topic_en"></span>
											<span ng-if="flagcheck == 2" ng-bind="topic_th"></span>
											<span ng-if="flagcheck == 3" ng-bind="topic_cn"></span>
					</div>
            ...
            <div class="borderdetail-check">
                    <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;"> 
                      <img src="images/service.png" width="30" style="margin-right: 15px;">
                        <span  ng-if="flagcheck == 1">Services</span>
                        <span  ng-if="flagcheck == 2">การให้บริการ</span>
                        <span  ng-if="flagcheck == 3">服务态度</span>
                    </div>
                    ...
                    <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;">
                     <img src="images/order.png" width="30" style="margin-right: 15px;">
                    ...
                    <table width="100%" style="margin-top: 10px;">
                    	<tr>
                    		<td>                    			
                        		<textarea  width="100%"  class="form-control" rows="4" ng-model="comment" ng-change="commentorther(comment)" ></textarea>
                    		</td>
                    	</tr>
                    </table>
						...
						<div class="box-in-comment" ng-repeat="item in getcommentviewhome" style="font-size: 16px;    padding-top: 7px;" ng-if="getcommentviewhome.length != 0 && checkcomment == 1">
							<div class="bodycomment-scroll" style="background: #f0f0f0;padding: 0 6px;border-radius: 8px 8px 0 0 ">
								<div style="display: inline-block;padding: 2px 0 "> 
									<img src="images/service.png" width="30" style="margin-right: 15px;">
									<span  ng-if="flagcheck == 1" style="color:#777 ">Services</span>
									<span  ng-if="flagcheck == 2" style="color: #777">การให้บริการ</span>
									<span  ng-if="flagcheck == 3" style="color:#777">服务态度</span>
								</div>
							...
							<div style="display: block;background: #f0f0f0;padding: 0 6px;">
               				...
               				<div class="box-com-se "   style="background: #f0f0f0;padding: 0 6px;padding: 0">                    
								<div style="padding: 0 6px;;font-size: 16px;"> 
									...
									<div class="" col="30" row="4" ng-model="item.comment" id="" style="margin-left: 14%;font-size: 16px" ng-if="item.comment != ''">{{item.comment}}</div>
                        
									<div class="" col="30" row="4" ng-model="item.comment" id="" style="margin-left: 14%;font-size: 16px" ng-if="item.comment == ''">
							...
							<div align="center" ng-bind="item.comment_date*1000 | date:' yyyy-MM-dd HH:mm:ss'"></div>
                
							<div align="center" style="padding: 5PX;"><i class="fa fa-smile-o" style="font-size: 60px;
    color: #fb893e"></i></div>
...
<div id="commentTour" class="modal fade" role="dialog">
  	<div class="modal-dialog">
    	<div class="modal-content">      
      		<div class="modal-body" style="padding: 0">
      			<i class="back_close" data-dismiss="modal" style="z-index: 1201;margin-top: 5px;">&#10006</i>
        		<input type="hidden" name="vccomment" value="{{vccomment}}">
				<div style="font-size: 16px; padding: 10px; background: #fff;  width: 100%;z-index: 1200;" align="center" align="center">
					<div style="position: absolute; width: 35px; text-align: center; height: 35px; background: #3b5998; border-radius: 8px 0px 45px 0px; line-height: 2; color: #fff;"><span ng-bind="index"></span>
					</div>
		...
		<div class="box-comment-popup">
            ...
            <div class="borderdetail-check">
                    <!-- <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;"> 
                      ...
                      <i class="fa fa-handshake-o" style="font-size: 30px ;color: #395999;margin-right: 15px;"></i>
                        <span  ng-if="flagcheck == 1">Complacency</span>
                        <span  ng-if="flagcheck == 2">ความพึงพอใจ</span>
                        <span  ng-if="flagcheck == 3">志得意满</span>
                    </div> -->
                    
                   <!--  <table width="100%">
                      	<tr>
                      		<td align="center" style="padding: 10px;">
                            	<i class="fa fa-star fa-lg dri" aria-hidden="true" ng-click="complacency(1)" id="complac1"></i>
                            	<i class="fa fa-star fa-lg dri" aria-hidden="true" ng-click="complacency(2)" id="complac2"></i>
                            	<i class="fa fa-star fa-lg dri" aria-hidden="true" ng-click="complacency(3)" id="complac3"></i>
                            	<i class="fa fa-star fa-lg dri" aria-hidden="true" ng-click="complacency(4)" id="complac4"></i>
                            	<i class="fa fa-star fa-lg dri" aria-hidden="true" ng-click="complacency(5)" id="complac5"></i>
                          	</td>
                      	</tr>
                    </table> -->
                    <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;">
                    ...
                    <table width="100%">
                      	<tr>
                      		<td align="center" style="padding: 10px;">
	                      		<i class="fa fa-star fa-lg pun" aria-hidden="true" ng-click="punctuality2(1)" id="pun21"></i>
	                          	<i class="fa fa-star fa-lg pun" aria-hidden="true" ng-click="punctuality2(2)" id="pun22"></i>
	                          	<i class="fa fa-star fa-lg pun" aria-hidden="true" ng-click="punctuality2(3)" id="pun23"></i>
	                          	<i class="fa fa-star fa-lg pun" aria-hidden="true" ng-click="punctuality2(4)" id="pun24"></i> 
	                          	<i class="fa fa-star fa-lg pun" aria-hidden="true" ng-click="punctuality2(5)" id="pun25"></i>
                          	</td>                          
                      	</tr>                      
                    </table>
                    <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;">
                     <!-- <img src="images/clean.png" width="30" style="margin-right: 15px;"> -->
                     <i class="fa fa-thumbs-up" aria-hidden="true" style="font-size: 33px ;color: #395999;margin-right: 15px;"></i>
                        <span  ng-if="flagcheck == 1">Satisfaction</span>
                        <span  ng-if="flagcheck == 2">ความพึงพอใจ</span>
                        <span  ng-if="flagcheck == 3">满意度</span>
                    </div>
                    <table width="100%">
                      	<tr>
                      		<td align="center" style="padding: 10px;">
                      			<i class="fa fa-star fa-lg cle" aria-hidden="true" ng-click="impressive(1)" id="impressive1"></i>
                          		<i class="fa fa-star fa-lg cle" aria-hidden="true" ng-click="impressive(2)" id="impressive2"></i>
                          		<i class="fa fa-star fa-lg cle" aria-hidden="true" ng-click="impressive(3)" id="impressive3"></i>
                          		<i class="fa fa-star fa-lg cle" aria-hidden="true" ng-click="impressive(4)" id="impressive4"></i>
                          		<i class="fa fa-star fa-lg cle" aria-hidden="true" ng-click="impressive(5)" id="impressive5"></i>
                          	</td>
                      	</tr>                     
                    </table>
                    <div style="background: #eee; padding: 5px 2px; font-size: 16px;border-radius: 8px 8px 0 0;">
             ...
             <div class="box-com-se"> 
                      ...
                      <i class="fa fa-handshake-o" style="font-size: 30px ;color: #395999;margin-right: 15px;"></i>
									...
									<span  ng-if="flagcheck == 1" style="color:#777 ">Complacency</span>
                        			<span  ng-if="flagcheck == 2" style="color:#777 ">ความพึงพอใจ</span>
                        			<span  ng-if="flagcheck == 3" style="color:#777 ">志得意满</span>
								</div>
								<div class="com-text" style="display: inline-block;float: right;">
									<div class="" ng-if="item.complacency == 1" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.complacency == 2" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.complacency == 3" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.complacency == 4" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									...
									<div class="" ng-if="item.complacency == 5" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
							...
							<div style="padding: 0 6px;">
								...
								<!-- <img src="images/clean.png" width="30" style="margin-right: 15px;"> -->
									...
									<i class="fa fa-thumbs-up" aria-hidden="true" style="font-size: 30px ;color: #395999;margin-right: 15px;"></i>
			                        <span  ng-if="flagcheck == 1" style="color: #777">Satisfaction</span>
			                        <span  ng-if="flagcheck == 2" style="color: #777">ความพึงพอใจ</span>
			                        <span  ng-if="flagcheck == 3" style="color: #777">满意度</span>
								</div>
                   
								<div class="com-text" style="display: inline-block;float: right;">
									<div class="" ng-if="item.impressive == 1" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.impressive == 2" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.impressive == 3" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.impressive == 4" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
									</div>
									<div class="" ng-if="item.impressive == 5" style="color: #08930e">
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
										<i class="fa fa-star fa-lg final" aria-hidden="true" ></i>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding: 0">
        	...
        	<div style="margin: 3px;padding: 10px;font-size: 17px; " align="center">
			...
			<div style="padding: 15px;">
				<input type="text" class="form-control" ng-change="inputroomnumberedit(editroom)" value="{{editroom}}" ng-model="editroom">
...
<div style="font-size: 16px; padding: 10px; background: #fff;  position: fixed; width: 100%; z-index: 1200;" align="center">
    ...
    <div class="modal-dialog" style="margin: 0;" >
	      ...
	      <div class="modal-content" style="margin-top: -17px;">
	        <div class="modal-body" id="headerdetail-boby" style="" >
	        	
	        	<input type="hidden" name="" value="{{VOUCHER}}">
	          	
	            <div ng-click="detailfirsthomein(VOUCHER)" data-toggle="modal" data-target="#" style="padding: 2px 10px;" ng-if="typeTour == 'transfer'&& checkDriver != null && checkDriver != ''">
	                <table width="100%" style="margin-bottom: 5px; color: #fff; border-radius: 8px;    background: #3b5998;">
						<tr>                                 
							<td align="center" style=" padding: 5px 0; " width="60">
								<div  style="position: relative;border: 0px solid #999999; width: 30px; height: 30px; text-align: center;    border-radius: 60px; margin-left: 2%;    color: #3b5998; background: #fff;    box-shadow: 1px 1px 5px #999999;">
                ...
                <div style="font-size: 16px;background:#f0f0f0;border-bottom: 1px solid #ddd;text-align: center;padding: 10px 0" ng-if="typeTour == 'transfer'">
                    <!-- <div class="textdetail" style="display: block;font-size: 16px;text-align: center;">
                    ...
                    <div class="textdetail" style="text-align: center;" >
                    	<span class="" ng-if="flagcheck == 1" >{{web_extra_way_topic_en}}</span>
                ...
                <table style="font-size: 16px" width="100%" ng-if="typeTour == 'transfer'">
                    ...
                    <tr style="background:#f0f0f0;border-bottom: 1px solid #fff;">
                      <td></td>
                      <td style="padding: 10px 0">
                         <span class="" ng-if="flagcheck == 1">Amount :</span>
                          <span class="" ng-if="flagcheck == 2">จำนวน : </span>
                          <span class="" ng-if="flagcheck == 3">人民 :</span>
                      </td>
                      <td></td>
                      <td colspan="3">
                          	<span ng-if="adult != 0">
                    ...
                    <tr ng-if="area == 'In'" style="background-color: #f0f0f0;">
                        <td></td>
                        <td style="padding: 10px 0">
                    ...
                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-if="area == 'Out'">
                        <td></td>
                        <td style="padding: 10px 0">
                    ...
                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="area == 'In'">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span ng-if="flagcheck == 1">Pick up sign :</span>
                            <span ng-if="flagcheck == 2">ป้ายรับแขก :</span>
                    ...
                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-if="area == 'In'">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span ng-if="flagcheck == 1">Visa on Arrival:</span>
                            <span ng-if="flagcheck == 2">วีซ่าเมื่อมาถึง :</span>
                            <span ng-if="flagcheck == 3">落地签证 :</span>
                        </td>
                        <td></td>
                        <td colspan="3">
                            <span  ng-if="visa_in == 1 ">Yes</span>
                            <span  ng-if="visa_in == 0 ">No</span>

                        </td>
                        
                    </tr>
                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="area == 'Out'">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span ng-if="flagcheck == 1">Flight departure:</span>
                            <span ng-if="flagcheck == 2">เที่ยวบินขาออก:</span>
                            <span ng-if="flagcheck == 3">航班起飞 :</span>
                        </td>
                        <td></td>
                        <td colspan="3">
                        	<div ng-if="terminal_in == 0 ">
                        		<span ng-if="flagcheck == 1">Not select </span>
	                            <span ng-if="flagcheck == 2">ไม่ได้เลือก</span>
	                            <span ng-if="flagcheck == 3">无选择  </span>
                        	</div>
                        	<div ng-if="terminal_in == 1 ">
                        		<span ng-if="flagcheck == 1"> Domestic</span>
	                            <span ng-if="flagcheck == 2">ภายในประเทศ</span>
	                            <span ng-if="flagcheck == 3">国内   </span>
                        	</div>
                        	<div ng-if="terminal_in == 2 ">
                        		<span ng-if="flagcheck == 1">  International</span>
	                            <span ng-if="flagcheck == 2">ต่างประเทศ</span>
	                            <span ng-if="flagcheck == 3">国际  </span>
                        	</div>
                            <!--  -->
                    ...
                    <tr style="background-color: #fff" ng-if="area == 'In'">
                        <td></td>
                        <td style="padding: 10px 0">
                    ...
                    <tr style="background-color: #f0f0f0" ng-if="area == 'Out'">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span class="" ng-if="flagcheck == 1">Number of car :</span>
                            <span class="" ng-if="flagcheck == 2">จำนวนรถ :</span>
                    ...
                    <tr ng-if="area == 'In'" style="background:#f0f0f0;border-bottom: 1px solid #ddd;">
                        <td></td>
                    ...
                    <tr ng-if="area == 'Out'" style="background:#fff;border-bottom: 1px solid #ddd;">
                        <td></td>
                        <td " style="padding: 10px 0">
                    ...
                    <tr ng-if=" area == 'In'" style="background-color: #fff">
                        <td></td>
                        <td style="padding: 10px 0">
                    ...
                    <tr ng-if="area == 'Out'" style="background-color: #f0f0f0">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span class="" ng-if="flagcheck == 1">Flight :</span>
                            <span class="" ng-if="flagcheck == 2">เที่ยวบิน :</span>
                    ...
                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-if="area == 'In'">
                        ...
                        <td style="padding: 10px 0">
                            ...
                            <span class="" ng-if="flagcheck == 2">วันที่ใช้บริการ :</span>
                    ...
                    <tr style="background-color: #fff" ng-if="area == 'In'">
                        ...
                        <td></td>
                        <td>
                            <span>{{airout_time}}</span>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr style="background-color: #fff" ng-if="area == 'Out'">
                        <td></td>
                        <td style="padding: 10px 0">
                            <span class="" ng-if="flagcheck == 1">Pick up Time :</span>
                            <span class="" ng-if="flagcheck == 2">เวลารับ :</span>
                    ...
                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="area != 'In'">
                      ...
                      <td></td>
                      <td colspan="2">
                          <span ng-if="room_number.length == 0"><input type="text" id="{{room}}" class="form-control" name="roomnum" ng-model="roomnum" ng-change="inputroomnumber(roomnum)"></span>
                          <div ng-if="room_number.length != 0" ng-click="editRoomnumber(room_number)" style="    border: solid 1px #06c10e; padding: 7px; border-radius: 8px;"><span  ng-bind="room_number" ></span></div>
                          
                      </td>
                      <td></td>
                      <!-- <td></td>
                      <td align="center">
                      		<i class="fa fa-floppy-o fa-2x " aria-hidden="true" style="font-size: 18px;padding: 0 10px;color: #3b5998" ng-click="putRoomnumber()" ng-if="room_number.length == 0 "></i >
                    ...
                    <style>
						...
						#notinputroom{ /*or other element you want*/
                    ...
                    <tr style="background-color: #f0f0f0" ng-style="set_color(area)" ng-if="area == 'Out'">
                      <td></td>
                      <td style="padding: 10px 0">
                    ...
                    <tr style="background-color: #fff" ng-style="set_color(area)" ng-if="area != 'Out'">
                      <td></td>
                      <td style="padding: 10px 0">
                          <span class="" ng-if="flagcheck == 1">Book by :</span>
                          <span class="" ng-if="flagcheck == 2">คนจอง :</span>
                    ...
                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="area == 'Out'">
                      <td></td>
                      <td style="padding: 10px 0">
                          <span class="" ng-if="flagcheck == 1">Date / Time :</span>
                          <span class="" ng-if="flagcheck == 2">วันที่ / เวลา :</span>
                          <span class="" ng-if="flagcheck == 3">日期 / 時間 :</span>
                      </td>
                      <td></td>
                      <td colspan="3">
                    ...
                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="area == 'Out'">
                     ...
                     <tr style="border-bottom: 1px solid #ddd;background:#fff;" ng-if="remark.length > 0">
	                    ...
	                    <tr style="border-bottom: 1px solid #ddd;background:#f0f0f0;" ng-if="depo && remark.length > 0">
	                      <td></td>
	                      <td style="padding: 10px 0">
	                			<span class="" ng-if="flagcheck == 1">Deposit:</span>
	                          	<span class="" ng-if="flagcheck == 2">ฝากเก็บเงิน :</span>
	                          	<span class="" ng-if="flagcheck == 3">代收定金:</span>
	                		</td>
	                      <td></td>
	                      <td colspan="3">
	                          <span ng-bind="datadepo | currency:'':0" style="color: red;margin-right: 15px;"></span>
	                          <span class="" ng-if="flagcheck == 1">THB</span>
	                          	<span class="" ng-if="flagcheck == 2">บาท</span>
	                          	<span class="" ng-if="flagcheck == 3">銖</span>
	                      </td>
	                      <td></td>
	                   </tr>
	                   <tr style="border-bottom: 1px solid #ddd;background:#fff;" ng-if="depo && remark.length <= 0">
	                      <td></td>
	                      <td style="padding: 10px 0">
	                			<span class="" ng-if="flagcheck == 1">Deposit:</span>
	                          	<span class="" ng-if="flagcheck == 2">ฝากเก็บเงิน :</span>
                ...
                <div ng-if="area == 'Rental'" style="margin-top: 10px; border: 1px solid #3b5998; border-radius: 8px; padding: 2px 10px; margin-bottom: 20px;font-size: 16px;">
              	...
              	<Br ng-if="typeTour == 'transfer'"/>
                <div align="left" style="padding: 2px 5px;font-size: 15px;text-shadow: none" ng-if="typeTour == 'transfer'">
			                ...
			                <div style="padding: 3px 3px;  border-radius: 8px; background: #fff;" ng-if="typeTour == 'transfer'">
			                  ...
			                  <tr ng-repeat="p in detailitem"  ng-class="{evencapa: $even, oddcapa: $odd}">
			                      ...
			                      <td align="center"><span ng-bind="p.plan"></span></td>
			                       <td >
			                          ...
			                          <span style="display:inline-block" ng-show=" p.adult == 1 && p.adult != 0">
			                          ...
			                          <span ng-if="p.adult == 6 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                          ...
			                          <span ng-if="p.adult == 7 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                          ...
			                          <span ng-if="p.adult == 8 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                          ...
			                          <span ng-if="p.adult == 9 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                          ...
			                          <span ng-if="p.adult == 10 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                          ...
			                          <span ng-if="p.adult == 11 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                           ...
			                           <span ng-if="p.adult == 12 && p.adult != 0">
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                            <i class="fa fa-male fa-lg" aria-hidden="true" ></i>
			                       ...
			                       <td >
			                          ...
			                          <span style="display:inline-block" ng-show="p.child != 0">
			                            ...
			                            <!-- <span style="float: right;">(5)</span> -->
			                              ...
			                              <span ng-if="p.child == 6 && p.child != 0">
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                            ...
			                            <!-- <span style="float: right;">(6)</span> -->
			                              ...
			                              <span ng-if="p.child == 7 && p.child != 0">
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                            ...
			                            <!-- <span style="float: right;">(7)</span> -->
			                              ...
			                              <span ng-if="p.child == 8 && p.child != 0">
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                            ...
			                            <!-- <span style="float: right;">(8)</span> -->
			                              ...
			                              <span ng-if="p.child == 9 && p.child != 0">
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                            ...
			                            <!-- <span style="float: right;">(9)</span> -->
			                              ...
			                              <span ng-if="p.child == 10 && p.child != 0">
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                                <i class="fa fa-child " aria-hidden="true" ></i>
			                      ...
			                      <td >
			                        ...
			                        <span style="display:inline-block;float: left;" ng-show="p.bag_big != 0">
			                        <i class="fa fa-suitcase fa-2x" aria-hidden="true" ng-if="p.bag_big == 1"></i>
			                        </span>
			                        <span style="float: left;" ng-if="p.bag_big == 2 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>

			                        </span>
			                        <span style="float: left;" ng-if="p.bag_big == 3 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        </span>
			                        <span style="float: left;" ng-if="p.bag_big == 4 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        </span>
			                        <span style="float: left;" ng-if="p.bag_big == 5 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        ...
			                        <span style="float: left;" ng-if="p.bag_big == 6 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        ...
			                        <span style="float: left;" ng-if="p.bag_big == 7 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        ...
			                        <span style="float: left;" ng-if="p.bag_big == 8 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        ...
			                        <span style="float: left;" ng-if="p.bag_big == 9 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                        ...
			                        <span style="float: left;" ng-if="p.bag_big == 10 && p.bag_big != 0">
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                          <i class="fa fa-suitcase fa-2x" aria-hidden="true" ></i>
			                      ...
			                      <td >
			                          ...
			                          <span style="display:inline-block;float: left;" ng-show="p.bag_small != 0">
			                          <i class="fa fa-suitcase " aria-hidden="true" ng-if="p.bag_small == 1"></i>
			                          </span>
			                          <span style="float: left;" ng-if="p.bag_small == 2 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>

			                          </span>
			                          <span style="float: left;" ng-if="p.bag_small == 3 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          </span>
			                          <span style="float: left;" ng-if="p.bag_small == 4 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          </span>
			                          <span style="float: left;" ng-if="p.bag_small == 5 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          ...
			                          <span style="float: left;" ng-if="p.bag_small == 6 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          ...
			                          <span style="float: left;" ng-if="p.bag_small == 7 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          ...
			                          <span style="float: left;" ng-if="p.bag_small == 8 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          ...
			                          <span style="float: left;" ng-if="p.bag_small == 9 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                          ...
			                          <span style="float: left;" ng-if="p.bag_small == 10 && p.bag_small != 0">
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
			                            <i class="fa fa-suitcase " aria-hidden="true" ></i>
            ...
            <div>
                ...
                <!-- TYPE TOUR -->
	                ...
	                <!-- <div style="font-size: 16px;background:#f0f0f0;border-bottom: 1px solid #ddd;text-align: center;" ng-if="typeTour != 'transfer'" ng-repeat="item in dataTour">
	                ...
	                <table style="font-size: 16px" width="100%" ng-if="typeTour != 'transfer'" ng-repeat="item in dataVoucher">
                      ...
                      <td></td>
                      <td colspan="3">
                          	<span ng-if="item.adult != 0">
			                      <span ng-if="flagcheck == 1">Adult : </span>
			                        <span ng-if="flagcheck == 2">ผู้ใหญ่ : </span>
			                        <span ng-if="flagcheck == 3">成人 :</span>		                    
			                   			<span ng-bind="item.adult"></span>
			                </span>
			                <span ng-if="item.child != 0">	
			                        <span ng-if="flagcheck == 1">Child :</span>
			                        <span ng-if="flagcheck == 2">เด็ก : </span>
			                        <span ng-if="flagcheck == 3">儿童 :</span>
			                   			<span ng-bind="item.child"></span>
			                </span>
                      ...
                      <td></td>
	                    ...
	                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="item.transfer == 0 " >
	                        <td></td>
	                        <td style="padding: 10px 0">
	                            <span class="" ng-if="flagcheck == 1">On Date :</span>
	                            <span class="" ng-if="flagcheck == 2">วันที่ใช้บริการ :</span>
	                    ...
	                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-if="item.transfer != 0 && item.area != Point" >
	                        <td></td>
	                        <td style="padding: 10px 0">
	                            <span class="" ng-if="flagcheck == 1">On Date :</span>
	                            <span class="" ng-if="flagcheck == 2">วันที่ใช้บริการ :</span>
	                    ...
	                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="item.transfer != 0 && item.area == Point" >
	                        <td></td>
	                        <td style="padding: 10px 0">
	                            <span class="" ng-if="flagcheck == 1">On Date :</span>
	                            <span class="" ng-if="flagcheck == 2">วันที่ใช้บริการ :</span>
	                   ...
	                   <!--  <tr ng-if="item.transfer != '0' && item.area != 'Point'">
	                        <td></td>
	                        <td style="padding: 10px 0" >
	                            <span class="" ng-if="flagcheck == 1">Pick up Time :</span>
	                            <span class="" ng-if="flagcheck == 2">เวลารับ :</span>
	                    ...
	                    <tr ng-if="item.transfer == 1 && item.area == 'Point'" style="background-color: #f0f0f0">
	                        <td></td>
	                        <td style="padding: 10px 0" >
	                            <span class="" ng-if="flagcheck == 1">Pick up Time :</span>
	                            <span class="" ng-if="flagcheck == 2">เวลารับ :</span>
	                    ...
	                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;">
	                        ...
	                        <td></td>
	                        <td >
	                            <span ng-bind="item.airin_time" ng-if="item.round_open == 0"></span>
	                            <span ng-if="item.round_open == 1">
	                            	<span ng-if="flagcheck == 1" ng-bind="item.round_th"></span>
		                            <span ng-if="flagcheck == 2" ng-bind="item.round_en"></span>
		                            <span ng-if="flagcheck == 3" ng-bind="item.round_cn"></span>
	                            </span>
	                    ...
	                    <tr style="background:#fff;border-bottom: 1px solid #ddd;" ng-if="item.to_place != 0">
	                      <td></td>
	                      <td style="padding: 10px 0">
	                      ...
	                      <td></td>
	                      <td>
	                          <span>{{item.tour_place_back}}</span>
	                      </td>
	                      <td></td>
	                      <td align="center">
	                      		<!-- <a href="{{item.map}}" target="_blank"> -->
	                          <img src="images/icon/view/map.png"  width="30" ng-click="tourPlace(item)">
	                          <!-- </a> -->
	                      </td>
	                      <td></td>
	                    </tr>
	                    <tr style="background-color:  #f0f0f0" ng-if="item.back_place != 0">
	                      <td></td>
	                      <td style="padding: 10px 0">
	                    ...
	                    <tr style="background:#fff;border-bottom: 1px solid #ddd;">
	                      ...
	                      <td></td>
	                      <td colspan="3">
                          <span ng-if="room_number.length == 0"><input type="text" id="{{room2}}" class="form-control" name="roomnum" ng-model="roomnum" ng-change="inputroomnumber(roomnum)"></span>
                      ...
                      <td align="center">
	                    ...
	                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;">
	                        ...
	                        <td></td>
	                        <td colspan="4">
	                            <span ng-if="flagcheck == 1" ng-bind="item.TB_admin_company"></span>
	                            <span ng-if="flagcheck == 2" ng-bind="item.TB_admin_company_th"></span>
	                            <span ng-if="flagcheck == 3" ng-bind="item.TB_admin_company_cn"></span>
	                    ...
	                    <tr style="background:#fff;">
	                      ...
	                      <td></td>
	                      <td>
	                          <span ><i  class="fa fa-user" aria-hidden="true" style="margin-right: 10px;color: #3b5998;font-size: 20px;display: inherit;"></i>{{item.TB_admin_nameissue}}
	                          </span>
	                      </td>
	                      <td></td>
	                      <td align="center" style="text-align: center;">
	                    			...
	                    			<tr>
	                    					...
	                    					<img src="images/mask.png" ng-click="" width="25" align="left">
	                    						<span ng-if="flagcheck == 1">Mask </span>
					                          	<span ng-if="flagcheck == 2">หน้ากาก </span>
	                    			...
	                    			<tr>
	                    					...
	                    					<img src="images/fins.png" ng-click="" width="25" align="left">
	                    						<span ng-if="flagcheck == 1">Fins</span>
					                          	<span ng-if="flagcheck == 2">ตีนกบ</span>
	                    			...
	                    			<tr>
	                    					...
	                    					<img src="images/wetsuit.png" ng-click="" width="25" align="left">
	                    						<span ng-if="flagcheck == 1">Wetsuit </span>
					                          	<span ng-if="flagcheck == 2">ชุดดำน้ำ</span>
	                    			...
	                    			<tr>
	                    					...
	                    					<img src="images/oxygen.png" ng-click="" width="25" align="left">
	                    						<span ng-if="flagcheck == 1">Regulator </span>
					                          	<span ng-if="flagcheck == 2">ท่อสำหรับหายใจ</span>
...
<div class="modal fade" id="stylepoupmyinfo">
    ...
    <div class="modal-dialog"  style="margin: 0;margin-top: -3px">
      	<div class="modal-content">
	        <div class="modal-body" id="headinfo-body" style="padding-top: 0;">
	        	<div style="padding:3px 2px; background: #fff; border-radius: 8px;">
			            <table style="font-size: 16px;" cellspacing="0" cellpadding="0" width="100%">
			                ...
			                <tr style="border-bottom: 1px solid #ddd;" ng-click="agent_guest_name(2)" data-toggle="modal" data-target="#guest_country">
			                    ...
			                    <td >
			                    <div  >
			                            <img src="iconstatus/flag/test_f/{{countryCode}}.png" width="25" style="display: inline-block;" />
			                ...
			                <tr style="background: #f0f0f0;border-bottom: 1px solid #ddd;">
			                    ...
			                    <td width="35" style="padding: 5px 0;" valign="top"> 
			                       <img src="images/phone2.png" width="35" ng-click="agent_guest_name(3)" data-toggle="modal" data-target="#phone3">
			                    </td>
			                    <td width="10" ></td>
			                    <td valign="middle" >
			                        
			                        <img src="iconstatus/flag/test_f/{{imgcoutry3}}.png" width="22" style="margin-right: 5px">
			                        <span ng-bind="web_book_agent_phone2"></span><i ng-click="agent_guest_name(12);" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998;  margin-top: 2px; right: 0; display: inline-block;   " aria-hidden="true"  data-toggle="modal" data-target="#Ephone3"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr style="background: #fff;border-bottom: 1px solid #ddd;">
			                    <td width="10" ></td>
			                    <td width="35" style="padding: 5px 0;" valign="top"> 
			                       <img src="images/localphone.png" width="35" ng-click="agent_guest_name(6)" data-toggle="modal" data-target="#phone2">
			                    </td>
			                    <td width="10" ></td>
			                    <td valign="middle" >
			                 ...
			                 <tr style="border-bottom: 1px solid #ddd;background-color: #f0f0f0" >
			                    <td width="10"></td>
			                    <td width="35" style="padding: 5px 0;" valign="top"> 
			                    ...
			                    <td width="10" ></td>
			                    <td valign="middle" >
			                         <span style="text-transform: lowercase;" ng-bind="guestEmail"></span>
			                ...
			                <tr style="background: #fff;border-bottom: 1px solid #ddd;">
			                    ...
			                    <td width="10" "></td>
			                    <td valign="middle" ">
			                       <span style="text-transform: lowercase;" ng-bind="guestEmail2"></span>
			            ...
			            <div >
			            <table width="100%" >
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialfaceid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idfacenull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconfacenull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_fb"></span>
			                        <i ng-click="editfunsocialnull(idfacenull,iconfacenull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwechatid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idwechatnull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconwechatnull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_wechat"></span>
			                        <i ng-click="editfunsocialnull(idwechatnull,iconwechatnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="sociallineid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idlinenull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconlinenull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_line"></span>
			                        <i ng-click="editfunsocialnull(idlinenull,iconlinenull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}"  ng-if="socialqqid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idqqnull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconqqnull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_qq"></span>
			                        <i ng-click="editfunsocialnull(idqqnull,iconqqnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialskypeid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idskypenull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconskypenull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_skype"></span>
			                        <i ng-click="editfunsocialnull(idskypenull,iconskypenull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwangid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idwangnull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconwangnull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_ww"></span>
			                        <i ng-click="editfunsocialnull(idwangnull,iconwangnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwhatid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idwhatnull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconwhatnull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_what"></span>
			                        <i ng-click="editfunsocialnull(idwhatnull,iconwhatnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
			                    
			                </tr>
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialzelloid == ''">
			                    <td width="10"></td>
			                    <td width="40"> 
			                        <div class="show{{idzellonull}}" style="padding: 5px 0">
			                            <img img src="images/social/{{iconzellonull}}" width="35" height="35">
			                        </div>
			                    </td>
			                    <td width="20"></td>
			                    <td >
			                        <span ng-bind="s_zello"></span>
			                        <i ng-click="editfunsocialnull(idzellonull,iconzellonull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialallnull"></i>
			                    </td>
			                    <td width="10"></td>
...
<div style="font-size: 16px; padding: 10px; background: #fff;  width: 100%;z-index: 
	...
	<div class="modal-dialog" style="margin-left: 0;margin-right: 0;margin-bottom: 0;margin-top: -3px;" >  
	    <div class="modal-content" style="border-top-right-radius: 0;   border-top-left-radius: 0;">	
	    	<div class="modal-body" id="headerdriverdetail-body" style="padding: 10px;padding-bottom: 0">
                ...
                <div style="padding: 2px 5px;font-size: 17px;text-shadow: none">
                ...
                <div style=" padding-bottom: 20px; padding: 0;background: #fff;    border-radius: 8px;"  align="center">
			                            ...
			                            <td>
			                                ...
			                                <div style="width: 100%" class="{{stylecarcolor}}">
			                                    <div align="center" class="carnumber" style="padding: 0;font-size: 16px;margin: 0;width: 48%;    display: inline-block; float: left;">
			                                        <span class="" ng-if="flagcheck == 1">Car</span>
			                                        <br/>
			                                        <span class="" ng-if="flagcheck == 1">number</span>
			                                    ...
			                                    <div align="center" style="padding: 0; font-size :16px;width:48%;float: right;">
			                                        <span class="" ng-if="flagcheck == 1">Car</span>
			                                           <br>
			                                        <span class="" ng-if="flagcheck == 1">color</span>

			                                        <span class="" ng-if="flagcheck == 2">สีรถยนต์</span>
			                                        <span class="" ng-if="flagcheck == 3">汽车颜色</span>
			                                        <div ng-if="web_carall_car_color == 'Green'" class="{{stylecarcolorselect}}" align="center" style="font-size: 14px;color: #fff">
				                                         <span class="" ng-if="flagcheck == 1">Green</span>
				                                        <span class="" ng-if="flagcheck == 2">สีเขียว</span>
				                                        <span class="" ng-if="flagcheck == 3">綠色</span>
			                                    	</div>
			                                    	<div ng-if="web_carall_car_color == 'Yellow'" class="{{stylecarcolorselect}}" align="center" >
				                                         <span class="" ng-if="flagcheck == 1">Yellow</span>
				                                        <span class="" ng-if="flagcheck == 2">สีเหลือง</span>
				                                        <span class="" ng-if="flagcheck == 3">黃色</span>
			                                    	</div>
			                                    	<div ng-if="web_carall_car_color == 'Black'" class="{{stylecarcolorselect}}" align="center" style="font-size: 14px;color: #fff">
				                                         <span class="" ng-if="flagcheck == 1">Black</span>
				                                        <span class="" ng-if="flagcheck == 2">สัดำ</span>
				                                        <span class="" ng-if="flagcheck == 3">黑色</span>
			                                    	</div>
			                                    	<div ng-if="web_carall_car_color == 'White'" class="{{stylecarcolorselect}}" align="center" style="font-size: 14px;">
				                                         <span class="" ng-if="flagcheck == 1">White</span>
				                                        <span class="" ng-if="flagcheck == 2">สีขาว</span>
				                                        <span class="" ng-if="flagcheck == 3">白色</span>
			                                    	</div>
			                                    </div>
			                                </div>
			                    ...
			                    <table width="100%" style="margin-top: 10px;">
			                        ...
			                        <tr ng-if="web_driver_line_id.length != 0 && web_driver_line_id != null" style="background-color: #fff;">
			                            <td width="10"></td>
			                            <td style="padding: 5px 0;"  >
			                        ...
			                        <tr ng-if="web_driver_wechat_id.length != 0 && web_driver_wechat_id != null" style="background-color: #f0f0f0;">
			                            <td width="10"></td>
			                            <td style="padding: 5px 0;">
			                            ...
			                            <td align="center">
			                                <span>
			                                    <a href="weixin://"><i class="fa fa-plus fa-lg " aria-hidden="true" style="color: #3b5998;"></i>
			                                </span>
			                            </td>
			                           
			                            
			                        </tr>
			                        <tr ng-if="web_driver_whatsapp_id.length != 0 && web_driver_whatsapp_id != null" style="background-color: #fff;">
			                            <td width="10"></td>
			                            <td style="padding: 5px 0;">
			                        ...
			                        <tr ng-if="web_driver_skype_id.length != 0 && web_driver_skype_id != null" style="background-color: #f0f0f0;">
			                            <td width="10"></td>
			                            <td style="padding: 5px 0;">
			                 ...
			                 <Br/>
			                <div align="left" style="padding: 2px 5px;font-size: 17px;text-shadow: none">
			                ...
			                <table width="100%" style="">
											...
											<tr style="background-color: #f0f0f0">
												...
												<td  width="30%" valign="top" style="padding-bottom: 5px;padding-top: 5px;;">
    ...
    display: inline-block;">
												<img src="images/yes.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;
    margin-left: -18px;
    position: absolute;" ng-if="statearrived != 0">
    <img src="images/no.png?v=<?=$cache;?>1"  align="" style=" margin-top: 2px;margin-left: -18px;
    position: absolute;" ng-if="statearrived == 0">
    ...
    width: 120px;">
												...
												<div style="display: inline-block;position: absolute;    margin-left: 5px;" ng-if="statearrived != 0">
														<img src="images/map_pin.png" ng-click="getmapdrivercheck('statearrived')">

													<span ng-bind="statearrived_date*1000 | date:' yyyy-MM-dd '" ng-if="statearrived != 0"></span>
													<Br/>
													<span align="center" ng-bind="statearrived_date*1000 | date:' HH:mm:ss'" ng-if="statearrived != 0" style="margin-left: 30px; color: #3b5998;"></span>
													<div ng-if="statearrived == 0">
													<span> - </span><!-- 
														<span ng-if="flagcheck == 1" >Waiting </span>
														<span ng-if="flagcheck == 2">รอ </span>
													 ...
													 <!-- <img ng-click="getmapdrivercheck('statearrived')" ng-if="statearrived != 0" src="images/icon/view/map.png?v=<?=$cache;?>"  width="30" > -->
												</div>
													 <i class="fa fa-camera fa-lg pull-right"  ng-if="statearrived != 0" style="    position: absolute;
    color: #aaa;
    font-size: 25px;
    right: 0;
    line-height: 2;
    margin-right: 20px;"></i>
											...
											<tr>	
												<td  width="30%" valign="top" style="padding-bottom: 5px;padding-top: 5px;">
													<div style="color: #3b5998;  border-radius: 50%; width: 45px; height: 45px;  border: 3px solid #3b5998; background: #fff; padding: 9px; display: inline-block;">
    <img src="images/yes.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;margin-left: -18px;
    position: absolute;" ng-if="statevehicle != 0">
													<img src="images/no.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;margin-left: -18px;  position: absolute;" ng-if="statevehicle == 0">
    <span style="font-weight: 600;
    font-size: 16px;
    padding: 5px;">2</span>
    
</div>
													<div style="color: #fff; border-radius: 5%;  border: 3px solid #3b5998;  background: #3b5998;  display: inline-block;  padding: 8px; width: 120px;">

													<span ng-if="statevehicle == 1">
														<span ng-if="flagcheck == 1" >On the car </span>
														<span ng-if="flagcheck == 2">อยู่บนรถแล้ว </span>
														<span ng-if="flagcheck == 3">已在车上</span>
													</span>
													<span ng-if="statevehicle == 0">
														<span ng-if="flagcheck == 1" >Can not find</span>
														<span ng-if="flagcheck == 2">ไม่เจอแขก </span>
														<span ng-if="flagcheck == 3">找不到客人</span>
													</span>
													</div>
													<div style="display: inline-block;position: absolute;    margin-left: 5px;" ng-if="statevehicle != 0">
													<img src="images/map_pin.png?v=<?=$cache;?>1" ng-click="getmapdrivercheck('statevehicle')"  align="" style="">
													<div ng-if="statevehicle == 0">
													<span> - </span>
														<!-- <span ng-if="flagcheck == 1" >Waiting </span>
														<span ng-if="flagcheck == 2">รอ </span>
													...
													<span ng-bind="statevehicle_date*1000 | date:' yyyy-MM-dd ' " ng-if="statevehicle != 0"></span>
													<Br/>
													<span align="center" ng-bind="statevehicle_date*1000 | date:'HH:mm:ss' " ng-if="statevehicle != 0" style="margin-left: 30px; color: #3b5998;"></span>
													
													
													 <!-- <img ng-click="getmapdrivercheck('statevehicle')" ng-if="statevehicle != 0" src="images/icon/view/map.png?v=<?=$cache;?>"  width="30" > -->
													 </div>
													 <i class="fa fa-camera fa-lg pull-right" ng-if="statevehicle != 0" style="    position: absolute;
    color: #aaa;
    font-size: 25px;
    right: 0;
    line-height: 2;
    margin-right: 20px;"></i>
												...
												<tr style="background-color: #f0f0f0">
												<td  width="32%" valign="top" style="padding-bottom: 5px;padding-top: 5px;">
    ...
    display: inline-block;">
    <img src="images/yes.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;margin-left: -18px;
    position: absolute;" ng-if="statecomplete != 0">
													<img src="images/no.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;margin-left: -18px;
    position: absolute;" ng-if="statecomplete == 0">
    <span style="font-weight: 600;
    font-size: 16px;
...
<div style="color: #fff;
    ...
    width: 120px;">
											...
											<div style="display: inline-block;position: absolute;    margin-left: 5px;" ng-if="statecomplete != 0">
													<img src="images/map_pin.png?v=<?=$cache;?>1"  ng-click="getmapdrivercheck('complete')"  style="right: 0">

												<span ng-bind="statecomplete_date*1000 | date:' yyyy-MM-dd '" ng-if="statecomplete != 0"></span>
												<Br/>
												<span align="center" ng-bind="statecomplete_date*1000 | date:' HH:mm:ss'" ng-if="statecomplete != 0" style="margin-left: 30px; color: #3b5998;"></span>
													<div ng-if="statecomplete == 0">
													<span> - </span>
														<!-- <span ng-if="flagcheck == 1" >Waiting </span>
														<span ng-if="flagcheck == 2">รอ </span>
													...
													<!-- <img ng-click="getmapdrivercheck('complete')"  src="images/icon/view/map.png?v=<?=$cache;?>"  width="30" ng-if="statecomplete != 0"> -->
											</div>
													 <i class="fa fa-camera fa-lg pull-right" ng-if="statecomplete != 0" style="    position: absolute;
    color: #aaa;
    font-size: 25px;
    right: 0;
    line-height: 2;
    ...
    display: inline-block;">
												<img src="images/yes.png?v=<?=$cache;?>1"  align="" style="margin-top: 2px;
    margin-left: -18px;
    position: absolute;" ng-if="statecheckcar != 0">
    <img src="images/no.png?v=<?=$cache;?>1"  align="" style=" margin-top: 2px;margin-left: -18px;
    position: absolute;" ng-if="statecheckcar == 0">
    ...
    width: 120px;">
													...
													<span ng-if="flagcheck == 1">Check the baggage</span>
													<span ng-if="flagcheck == 2">ตรวจสอบสัมภาระ </span>
													<span ng-if="flagcheck == 3">檢查車內行李</span><Br/>
												</div>	
												<div style="display: inline-block;position: absolute;    margin-left: 5px;"  ng-if="statecheckcar != 0">
														<img src="images/map_pin.png" ng-click="getmapdrivercheck('statecheckcar')">

													<span ng-bind="statecomplete_date*1000 | date:' yyyy-MM-dd '" ng-if="statecheckcar != 0"></span>
													<Br/>
													<span align="center" ng-bind="statecomplete_date*1000 | date:' HH:mm:ss'" ng-if="statecheckcar != 0" style="margin-left: 30px; color: #3b5998;"></span>
													<div ng-if="statearrived == 0">
													<span> - </span><!-- 
														<span ng-if="flagcheck == 1" >Waiting </span>
														<span ng-if="flagcheck == 2">รอ </span>
													 ...
													 <!-- <img ng-click="getmapdrivercheck('statecheckcar')" ng-if="statearrived != 0" src="images/icon/view/map.png?v=<?=$cache;?>"  width="30" > -->
												</div>
													 <i class="fa fa-camera fa-lg pull-right" ng-if="statecheckcar != 0" style="    position: absolute;
    color: #aaa;
    font-size: 25px;
    right: 0;
    line-height: 2;
...
<div id="realtime" class="modal fade" role="dialog" >
	...
	<div id="tol" class="modal fade" role="dialog" style="background-color: rgb(221, 221, 221);">
  	<div class="modal-dialog" style="    margin-top: 200px;">
	    <div class="modal-content">
	    	<div class="modal-body" style="padding: 0">
	    	<i class="back_close " data-dismiss="modal" style="    position: absolute;
    ...
    right: 0px;">&#10006</i>
	    	...
	    	<div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;">
	    	<!-- <i class="fa fa-map-marker" aria-hidden="true" style="font-size: 20px; color: #3b5998;"></i> -->
				<span ng-if="flagcheck == 1">Contact number</span>
				<span ng-if="flagcheck == 2">เบอร์ติดต่อ</span>
				<span ng-if="flagcheck == 3">聯繫電話</span>
			</div>
			<div style="padding: 15px;font-size: 15px">
			<table width="100%">
				<tr>
					<td width="50%" align="center" ng-if="driverPhone != null" style="padding: 0 5px">
						<div style="border: 1px solid rgb(59, 89, 152);
    border-radius: 8px;
    padding: 5px 0;"><a href="tel:{{driverPhone}}" ng-click="confirm_sendmaildelay(10,orderChat)" style="text-decoration: none;color: #555;">
							<div>
								<span ng-if="flagcheck == 1">Driver</span>
								<span ng-if="flagcheck == 2">คนขับ</span>
								<span ng-if="flagcheck == 3">司机</span>
					...
					<td width="50%" align="center" style="padding: 0 5px">
						<div style="border: 1px solid rgb(59, 89, 152);
    border-radius: 8px;
    padding: 5px 0;"><a href="tel:0630781168" ng-click="confirm_sendmaildelay(11,orderChat)" style="text-decoration: none;color: #555;">
				<div>
...
<div id="locationSetting" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-body">

		    <i class="back_close" ng-click="" data-dismiss="modal" style="position: absolute;
    
    right: 0px;top: 0;">&#10006</i>
    </Br> 
		    <!-- <div style="width: 100%;padding: 10px"  ng-style="spintakechattoop">
    			<i class="fa fa-warning faa-flash animated " aria-hidden="true" style="color: #3b5998; font-size: 36px;"  ></i>
    		</div>  -->  
		    	<div align="center" style="font-size: 20px;">
		    	<!-- <i class="fa fa-warning faa-flash animated " align="left" aria-hidden="true" style="color: #3b5998; font-size: 30px;text-align: left;"  ></i> -->
		    		<span ng-if="flagcheck == 1">Unable to determine your location. Please turn on location services in your device's settings</span>
			    	<span ng-if="flagcheck == 2">ไม่สามารถโหลดข้อมูลตำแหน่งที่ตั้งได้โปรดเปิดใช้งานข้อมูลตำแหน่งที่ตั้งของคุณ</span>
			    	<span ng-if="flagcheck == 3">定位功能处于关闭状态。请开启定位功能。</span>
		    	</div>
...
<div id="videoTour" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
	      <i class="back_close" ng-click="" data-dismiss="modal" style="position: absolute; right: 0px;top: 0;">&#10006</i>
	    <div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;">
	    	<!-- <i class="fa fa-map-marker" aria-hidden="true" style="font-size: 20px; color: #3b5998;"></i> -->
		    ...
		    <div class="modal-body">
		    	...
		    	<!-- <i class="fa fa-warning faa-flash animated " align="left" aria-hidden="true" style="color: #3b5998; font-size: 30px;text-align: left;"  ></i> -->
		    		...
		    		<!-- <iframe id="iframes" ng-src="{{iframe.srcvideo | trusted}}" width="100%"></iframe> -->
					  <!-- <iframe margin="0" padding="0" border="none" width="100%" height="400" frameBorder="0"
					      ng-src="{{exercise_video_url}}">
					 </iframe>   -->
					  <!-- <div class="col-sm-6 wrapper"> -->
				          <ng-youtube-embed video="video1" width="100%" ng-if="video1 != ''">
				          </ng-youtube-embed>
				         
				           <ng-youtube-embed video="video2" width="100%" ng-if="video2 != ''">
				          </ng-youtube-embed>
				           
				           <ng-youtube-embed video="video3" width="100%" ng-if="video3 != ''">
				          </ng-youtube-embed>
...
<div id="mapdrivercheckin" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
	      <i class="back_close" ng-click="" data-dismiss="modal" style="position: absolute; right: 0px;top: 0;z-index: 100">&#10006</i>
	    <div align="center" style="font-size: 18px;margin-bottom: 0;">
		    ...
		    <div class="modal-body" style="padding: 5px;">
		    	...
		    	<!-- <i class="fa fa-warning faa-flash animated " align="left" aria-hidden="true" style="color: #3b5998; font-size: 30px;text-align: left;"  ></i> -->
		    		...
		    		<iframe id="iframes" ng-src="{{iframe.srcmapderivercheck | trusted}}" width="100%" margin="0" padding="0" border="none"   frameBorder="0" height="400"></iframe>
					  <!-- <iframe margin="0" padding="0" border="none" width="100%" height="400" frameBorder="0"
					      ng-src="{{exercise_video_url}}">
					 </iframe> -->  
    	...
    	<div class="modal-content">      
      		<div class="modal-body" style="padding: 0">
				...
				<div align="center" style="margin-bottom: 30px;">
					<img src="https://goldenbeachgroup.com/app/voucher/data/qr/vc/{{idvcQRcode}}_{{code}}.png" width="50%">
				</div>
