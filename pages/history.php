sadfasdfsadfas
<div data-role="page" id="history"  class="bg-body" ng-dblclick="doubleClick()">

<div style="padding: 0 10px;">
        
        
          <div class="record" ng-repeat="item in getallchat" id="anchormenudriver{{item.id}}" style="border: 1px solid #ddd; border-radius: 8px;margin-bottom: 10px;">
                <table id="record" width="100%" style="font-size: 16px;border-color: none !important" >
                    ...
                    <tr ng-if="item.state == 5" style="    background: #f0f0f0;">
                      ...
                      <td colspan="" align="center" width="50">
                          <img src="images/icon/view/map.png?v=<?=$cache;?>" ng-click="locationchatOPall(item)" width="30">
                      </td>
                    </tr>
