<div id="popup_chat_share_map"    style="width:100%; height:100%; padding:0px;  left:0px;  top:0px;   z-index:99999; background-color:#FFFFFF; position:absolute;  display:none; margin-top:0px;">
 ...
 <div   id="load_chat_share_map"   style="margin-top: 45px; height:80%"  >  
...
<center>
					 <button type="button" class="btn btn-modal-no" data-dismiss="modal"  data-backdrop="static" id="btn_close_gps_popup" ><?=chat_close?></button>
					 <button type="button" class="btn btn-modal-ok"     data-backdrop="static" id="btn_send_gps_point" ><?=chat_send?></button>
 </center>
