...
?>
                ...
                <div class="direct-chat-msg <?=$main_msg?>" >
                  <div class="direct-chat-info clearfix" style="margin-top:10px; margin-bottom:10px; ">
                    ...
                    <span class="direct-chat-timestamp <?=$main_timestamp?>"> <?=$date = date('Y-m-d ',  $arr[chat][flight_delay_date]);?>&nbsp;<font color="#000000"><?=$date = date('h:i:s',  $arr[chat][flight_delay_date]);?></font></span>
                  </div>
