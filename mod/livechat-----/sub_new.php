...
<div class="direct-chat-text">
  <? } ?>
			...
			&nbsp;<img src="../data/fileupload/photo/<?=$arr[chat][voucher];?>_<?=$arr[chat][flight_delay_date]?>_small.jpg"   align="absmiddle" style="padding: 5px 0; display:nonex" class="img-chat-pic">&nbsp;<?=$arr[chat][flight_delay]?>
