...
<center><img id="image_album" style="width:100%;border-radius: 0px;" /> </center>
 
</div> 

 
                   <div style="margin-top: 10px;"> <center>
					 <button type="button" class="btn btn-modal-no" data-dismiss="modal"  data-backdrop="static" id="btn_close_album_popup" >ปิด</button>
					 <button type="button" class="btn btn-modal-ok"     data-backdrop="static" id="btn_send_album_popup" >ส่ง </button>      </center>
                </div>
				                </div>
