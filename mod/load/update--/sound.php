...
<a  id="alert_auto_new_work" data-target="#popup_alert_new_work" data-toggle="modal"  data-backdrop="static" data-keyboard="false">1111</a>
<a  id="alert_auto_checkin" data-target="#popup_alert_lab_checkin" data-toggle="modal"  data-backdrop="static" data-keyboard="false">ททท</a>
<a  id="alert_auto_checkguest" data-target="#popup_alert_lab_checkguest" data-toggle="modal"  data-backdrop="static" data-keyboard="false">ปฟปป</a>
...
<div id="load_sound_lab_checkguest"></div>
   ...
   <div    class="modal fade" id="popup_alert_lab_checkin" role="dialog"   aria-labelledby="myModalLabel" style="z-index:19998; background-color:#FFFFFF"    >
...
var url_confirm_lab_checkin= "popup.php?name=lab/action&file=save&type=comfirm_checkin";
...
$("#load_sound_lab_checkin").html('');
   ...
   <div    class="modal fade" id="popup_alert_lab_checkguest" role="dialog"   aria-labelledby="myModalLabel" style="z-index:19999; background-color:#FFFFFF "    >
...
var url_confirm_lab_checkguest= "popup.php?name=lab/action&file=save&type=comfirm_checkguest";
...
$("#load_sound_lab_checkguest").html('');
  ...
  <!-- งานใหม่-->
   ...
   <div    class="modal fade" id="popup_alert_new_work" role="dialog"   aria-labelledby="myModalLabel" style="z-index:99999; background-color:#FFFFFF "    >
...
var url_confirm_new_work= "popup.php?name=lab/action&file=save&type=new_work";
