...
$res[project] = $db->select_query("SELECT * FROM ".TB_transfer_report_all."  where drivername='".$driver_id."' and transfer_date='". $daywork."'  and status = 'CONFIRM'  and airout_time <>'' group by invoice order by  airout_time ASC ");
