					...
					<table width="100%" style="font-size: 17px;">
						...
						<tr> 
							...
							<div style="font-size: 17px; margin: 5px 24px; padding: 5px; color: #3b5998; border-bottom: 1px solid #3b5998;">
								<span ng-if="flagcheck == 1" ng-bind="x.topic_en" ng-if="x.TB_order_type == 'transfer'"></span>
								<span ng-if="flagcheck == 2" ng-bind="x.topic_th" ng-if="x.TB_order_type == 'transfer'"></span>
								<span ng-if="flagcheck == 3" ng-bind="x.topic_cn" ng-if="x.TB_order_type == 'transfer'"></span>
								...
								<div style="margin-top: 10px;" >
									<table width="100%" style="font-size: 17px;color: rgba(97, 97, 97, 0.84);" >
										...
										<td align="center" style="padding-top: 8px;padding: 0" width="32%" ng-click="getbookinfomation(x,$index);">							
											...
											<td width="32%" align="center" style="padding-top: 8px;padding: 0"  ng-disabled="x.datessnew ==2" ng-if="x.TB_order_type == 'transfer'">

												<div class="main_iconhome" ng-click="openpopupdriverinfo(x);openpopuptodriver(x.TB_order_order);testss()"  data-toggle="modal" data-target="#chatdrivermodal" id="{{x.TB_order_order}}" onclick="chatTOdriver(this.id)">
	...
	<script type="text/javascript">
 	...
 	// 		//alert(flagcheck) 
		...
		function chatTOdriver(x){
			...
			// $('#vcload').html(voucher);
			// $('#nameload').html(name);
			var url_chat = "vc_chat.php?name=livechat&vc="+voucher+"&lang="+flagcheck+"&order="+dataorderID+"&to=driver";
 			$('#chat_load').load(url_chat);
		}
		function chatTOop(x){
			//console.log(x)
			...
			// $('#vcload').html(voucher);
			// $('#nameload').html(name);
			var url_chat = "vc_chat.php?name=livechat&vc="+voucher+"&lang="+flagcheck+"&order="+dataorderID+"&to=callcenter";
 			$('#chat_load').load(url_chat);
		}
