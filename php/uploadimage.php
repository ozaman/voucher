 ...
 {  
  ...
  //     }
             ...
             echo json_encode($data);
              ...
              //$source->getImageOrientation();
              //echo $source;
              $target = '../../data/fileupload/vc/' . $newNamePrefix .'.jpg';
              $source_image = '../../data/fileupload/vc/' . $newNamePrefix .'.jpg';
              ...
              //$data = getimagesize($imagename);
              //$savingdata = getImageOrientation();
              ...
              $manipulator = new ImageManipulator('../../data/fileupload/vc/' . $newNamePrefix .'.'.'jpg');
              $newImage = $manipulator->resample(80, 80);
              imagejpeg($tn, $save, 0) ;
