var app = angular.module('myApp', ['ngCookies','ngRoute','angular.filter','base64','ui.bootstrap','FBAngular','geolocation','ui-notification','ngAnimate','ngMessages']);
  ...
  $scope.shareLocation = function(){
            ...
            $http({
                        ...
                        console.log(res)
                        $scope.maptime = res.split(" ");
                        console.log($scope.maptime[1].split(" "))
                    //     $http({
                    //     method : 'POST',
                    //     url : "../vc2/saveImagemap.php",
                    //     data: $.param({                            
