...
<div modal="showModal" class="box-bg6"  ng-click="cancel()" ng-style="boby" id="bg-modal">
...
<!-- ************************* MEETING POINT ********************************** -->
<!-- ************************************************************************** -->
<div modal="showModal" class="box-bg8" ng-style="meeting" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		
		<div class="modal-body" id="body-photo" style="padding: 0">
		<i class="back_close " ng-click="cancelmeetingpoint()">&#10006</i>
			<div class="box-img-photo">
				<div style="font-size: 18px;padding-top: 10px;" align="center">
...
<!-- **************************** SIGN POINT ********************************** -->
<!-- ************************************************************************** -->
<div modal="showModal" class="box-bg9" ng-style="sign" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<div class="modal-body" id="body-photo" style="padding: 0">
		<i class="back_close " ng-click="cancelpickupsign()">&#10006</i>
			<div class="box-img-photo">
				<div style="font-size: 18px;padding-top: 10px;" align="center">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body" style="padding: 0;">
			...
			<p ng-click="language(3)" data-dismiss="modal" style="background: #f0f0f0;   padding: 5px;margin: 0;font-size: 18px;padding-left: 9px;">
						<img src="images/china.ico" width="35" style="margin-right: 5px">
						<span>简体中文</span>
					</p>
					<p ng-click="language(1)" data-dismiss="modal" style=" padding: 5px;margin: 0;font-size: 18px;padding-left: 9px;">
...
<!-- Change flight -->
<div class="modal fade" id="changedrivermodal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
...
<!-- flight delay-->
<div class="modal fade" id="flightdelaydrivermodal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
      		<i class="back_close " data-dismiss="modal">&#10006</i>
      		<div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;">
...
<!--  ******************Popup GoTo Before******************  -->
	<div class="modal fade" id="beforedrivermodal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
	    ...
	    <div class="modal-content">
	    	...
	    	<div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;background-color: #fff;border-radius: 8px 8px 0 0;">
					...
					<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 5px;border-radius: 0 0 8px 8px">
					   ...
					   <div style="padding: 5px 9px;display: none;" ng-style="frequentlyusedonthecar" >
						   <div style="border: solid 2px #3b5998;height: 285px;border-radius: 8px;overflow: auto; display: none;margin-bottom: 11px;margin-top: 7px;" ng-style="sdatamessageonthecar" >
    						...
    						<i class="fa fa-spinner faa-spin animated " aria-hidden="true" style="color: #3b5998; font-size: 36px;"></i>
						   	...
						   	<div ng-style="havedatamessageonthecar" align="center" style="margin-top: 15px;">
						   		<textarea class="form-control" rows="2" id="comment"  ng-style="" style="margin-bottom: 10px;border-radius: 8px; pointer-events: none;" value="{{SELmessage_store}}" ng-model="SELmessage_store"></textarea>
...
<!--      ******************Popup GoTo Delay******************          -->
<div id="delaydrivermodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
...
<!--      ******************Popup GoTo Wait******************          -->
<div id="waitdrivermodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
											...
											<table width="100%">
												<tr>
													...
													<td align="center"  width="48%">
														...
														<div ng-click="takepicturesfun();savetakein()" class="btn-save"  ng-style="btnclicktake">
...
<div id="chatdrivermodal" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
	    	<i class="back_close " ng-click="cancelid_popupdiverchat()" data-dismiss="modal">&#10006</i>
	    	<div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;background-color: #fff;border-radius: 8px 8px 0 0;">
						<img src="images/all_message.png?v=<?=$cache;?>" width="20" align="absmiddle">
					...
					<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 5px;border-radius: 0 0 8px 8px">
						<table width="100%" style="margin-top: 10px;margin-bottom: 10px;">
					   		<tr>
					   			<td width="10"></td>
					   			<td align="left" >
					   				<div style="float: left; padding: 9px 12px; background: #22407f;    text-shadow: none; border-radius: 8px; color: #fff;outline: none" ng-click="btnFrequentlyused()" ng-style="btnfre">
					   					<span ng-if="flagcheck == 1">Frequently used</span>
					   					<span ng-if="flagcheck == 2">ข้อความที่ใช้บ่อย</span>
					   					<span ng-if="flagcheck == 3">常用信息</span>
					   				</div>
					   			...
					   			<td width="10"></td>
					   			<td align="center">
					   				<div style="padding: 9px 12px; background: #3b5998; text-shadow: none;    border-radius: 8px; color: #fff;outline: none" ng-click="btnMessage()" ng-style="btnchat">
					   					<span ng-if="flagcheck == 1">Chat</span>
					   					<span ng-if="flagcheck == 2">แชท</span>
					   					<span ng-if="flagcheck == 3">聊</span>
					   				</div>
					   ...
					   <div style="padding: 5px 9px;display: none;" ng-style="frequentlyused" >
						   <div style="border: solid 2px #3b5998;height: 285px;border-radius: 8px;overflow: auto; display: block;margin-bottom: 11px;margin-top: 7px;" ng-style="sdatamessage" >
						   		<ul ng-repeat="item in messagedata" ng-class="{evenmesage: $even, oddmesage: $odd}" >
						   			<li ng-if="flagcheck == 1" ng-bind="$index+1+'.'+item.topic_en" ng-click="selectmessage(item)"></li>
						   			<li ng-if="flagcheck == 2" ng-bind="$index+1+'.'+item.topic_th" ng-click="selectmessage(item)"></li>
						   			<li ng-if="flagcheck == 3" ng-bind="$index+1+'.'+item.topic_cn" ng-click="selectmessage(item)"></li>
						   	...
						   	<div style="border: solid 2px #3b5998;height: 285px;border-radius: 8px;overflow: auto; display: none;margin-bottom: 11px;margin-top: 7px;" ng-style="sdatamessage_store" >
						   	<div style="font-size: 17px;"><i class="fa fa-angle-left" ng-click="btnFrequentlyused()" style="padding: 10px 10px;"></i><span ng-bind="headersmessage"></span></div>
						   		<ul ng-repeat="item in messagedataStore" ng-class="{evenmesage: $even, oddmesage: $odd}" >
						   			<li ng-if="flagcheck == 1" ng-bind="$index+1+'.'+item.topic_en" ng-click="selectmessage_store(item)"></li>
						   			<li ng-if="flagcheck == 2" ng-bind="$index+1+'.'+item.topic_th" ng-click="selectmessage_store(item)"></li>
						   			<li ng-if="flagcheck == 3" ng-bind="$index+1+'.'+item.topic_cn" ng-click="selectmessage_store(item)"></li>
						   		</ul>
						   	</div>
						   	<div style="width: 100%;top: 420px;position: absolute;display: none;" align="center" ng-style="spintakechattodriverselect">
    						<i class="fa fa-spinner faa-spin animated " aria-hidden="true" style="color: #3b5998; font-size: 36px;"></i>
    						</div>
						   	<div ng-style="havedatamessage" align="center" style="margin-top: 15px;">
						   		<textarea class="form-control" rows="2" id="comment"  ng-style="" style="margin-bottom: 10px;border-radius: 8px; pointer-events: none;" value="{{SELmessage_store}}" ng-model="SELmessage_store"></textarea>
						   		<div class="btm-checkin" ng-click="confirm_sendmaildelay(12,VCID)" style="margin-top: 15px;" >
									<i class="fa fa-paper-plane fa-2x " aria-hidden="true" style="font-size: 18px;padding: 0 10px;"></i>
								</div>
							</div>
					   </div>
						...
						<div style="padding: 5px 9px;margin-top: 9px;" ng-style="message">
							<textarea class="form-control" rows="5" id="comment" ng-model="comdriver" ng-change="YourOwnComments(comdriver)" ng-style="owncomments" style="margin-bottom: 10px;border-radius: 8px;"></textarea>
							<div class="btm-checkin" ng-click="confirm_sendmaildelay(2,VCID)" style="display: none;margin-top: 15px;" ng-style="confirmcommenttoderiver">
								<i class="fa fa-paper-plane fa-2x " aria-hidden="true" style="font-size: 18px;padding: 0 10px;"></i>
							</div>
...
<div modal="showModal" class="box-bg27" ng-click="cancel()" ng-style="guest_name" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" >
		...
		<div class="modal-body" id="body-photo" style="padding: 0">
           <i class="back_close fa fa-angle-left" ng-click="cancelid_popupcallcenterchat()" class=""></i>
...
<div modal="showModal" class="box-bg28" ng-click="cancel()" ng-style="guest_country" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<!-- <div class="modal-header">
...
<div modal="showModal" class="box-bg29" ng-click="cancel()" ng-style="phone1" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
...
<div modal="showModal" class="box-bg30"  ng-style="Ephone1" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="background-color: #f0f0f0">
      
		<div class="modal-body" id="body-photo" style="padding: 0">
           <i class="back_close fa fa-angle-left" ng-click="cancelEphone1()" class=""></i>
			<div class="box-img-photo">
				<div class="box-in-photo" >
					<div align="center" style="font-size: 18px;    padding: 5px;background-color: #fff">
...
<div modal="showModal" class="box-bg31"  ng-style="phone2" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<!-- <div class="modal-header">
...
<div modal="showModal" class="box-bg32" ng-click="cancel()" ng-style="adultchild" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<!-- <div class="modal-header">
...
<div modal="showModal" class="box-bg33"  ng-style="Ephone2" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="background-color: #f0f0f0">
      
		<div class="modal-body" id="body-photo" style="padding: 0">
           <i class="back_close fa fa-angle-left" ng-click="cancelEphone2()" class=""></i>

			<!-- <img src="images/cancel.png" ng-click="cancelEphone2()" align="center" class="modal_close" /> -->
			<div class="box-img-photo">
				<div class="box-in-photo" >
					<div align="center" style="font-size: 18px;padding: 5px;background-color: #fff">
...
<div modal="showModal" class="box-bg34"  ng-style="editEmail1" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<div class="modal-body" id="body-photo" style="padding: 0">
           <!-- <i class="back_close fa fa-angle-left" ng-click="canceleditEmail1()" class=""></i> -->
...
<div modal="showModal" class="box-bg35"  ng-style="editEmail2" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm">
		<div class="modal-body" id="body-photo" style="padding: 0">
          <!--  <i class="back_close fa fa-angle-left" ng-click="canceleditEmail2()" class=""></i> -->
			...
			<div class="box-img-photo">
				<div class="box-in-photo" >
					...
					<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 15px;    border-radius: 0 0 10px 10px;" align="center">
						...
						<div class="btn-saveso"  ng-click="savesocialquest_detail()" style="    margin-top: 15px;padding: 11px;text-align: center;"  ng-style="reqsave" >
							<span class="fa fa-save "  aria-hidden="true" align="center" style="font-size: 20px"></span>
							<span ng-if="flagcheck == 1">Save</span>
							<span ng-if="flagcheck == 2">บันทึก</span>
							<span ng-if="flagcheck == 3">保存</span>
...
<div modal="showModal" class="box-bg36"  ng-style="editsocialall" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="background-color: #f0f0f0">
		<div class="modal-body" id="body-photo" style="padding: 0">
           <!-- <i class="back_close fa fa-angle-left" ng-click="canceleditsocialall()" class=""></i> -->
			...
			<div class="box-img-photo">
				<div class="box-in-photo" >
					...
					<div align="center" style="font-size: 18px;    padding: 5px;background-color: #fff">
						...
						<!-- <img src="/{{itemicon}}" width="30" class="icon-so"> -->
						<span  ng-if="flagcheck == 1">Edit social</span>
						<span  ng-if="flagcheck == 2">แก้ไขโซเชียล</span>
						<span  ng-if="flagcheck == 3">编辑社会</span>
						<!-- <img src="images/lang.png.png" width="35"> -->
					</div>
					<div ng-repeat="item in socialall" class="Edit{{item.id}}"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 8px;padding-top: 20px;display: none">
	...
	<div class="modal-body" style="background: #f0f0f0;position: fixed; top: 0; right: 0; bottom: 0;  left: 0; padding: 0; z-index: 101; display: none; width: 100%; height: auto;overflow-y: scroll;overflow-x: hidden; " ng-style="popupdriverinfo" id="bg-modal">
		<div id="body-photo" style="padding: 0;">
			<div class="box-img-photo">
						...
						<li  style=" margin-bottom: 0; background: #f0f0f0; border-radius: 0 0 8px 8px;">
							...
							<table width="100%" cellpadding="8" cellspacing="8">
											<tr>  
												<td colspan="5">
													<div style="padding: 0 5px">
														<div ng-click="detailfirsthome(vdIDclickinfo)">
											...
											<tr>
												...
												<td width="10"></td>
												<td align="center" >
													<a href="tel:{{TB_driver_phone}}" ng-click="confirm_sendmaildelay(10,vdIDclickinfo)" style="text-decoration: none;color: #555;"><img src="images/phone.png?v=<?=$cache;?>" width="35" align="center" align="absmiddle" style="padding: 5px 0;">
													<br />
													<span ng-if="flagcheck == 1" >Call</span>
													<span ng-if="flagcheck == 2">โทร </span>
													<span ng-if="flagcheck == 3">通话</span>
				...
				<div class="box-in-photo" style="margin-top: 40px;">
		...
		<div class="" id="body-photo" style="padding: 0;">
			...
			<div class="box-img-photo">
				<div ng-style="figmenuop" style="background-color: #fff;width: 100%">
					...
					<div style="font-size: 18px; padding: 5px;background-color: #fff" align="center">                    
						...
						<li style="background-color: #f0f0f0;border-radius:8px;margin-bottom: 0    ">
							...
							<table width="100%" cellpadding="8" cellspacing="8">
								<tr ng-if="checkarea == 'In'">
											...
											<tr>
												<td align="center" ng-click="sharelocationtoop(vdIDclickinfo)" data-toggle="modal" data-target="#sharelocationtodriver_toop">
													<i class="fa fa-map-marker" aria-hidden="true" style="font-size: 45px; color: #3b5998;"></i>
													<!-- <img src="images/allhis.png?v=<?=$cache;?>" width="30"  align="absmiddle" style="padding: 5px 0;"> --><br>
		...
		<i class="back_close " ng-click="cancel()" >&#10006</i>
			<div class="box-img-photo">
				...
				<div class="box-in-photo"  style="font-size: 15px;">
					...
					<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 5px;    border-radius: 0 0 10px 10px;" ng-if="state6[0].status_confirm !=0">
                        <table style=" border-color: #f0f0f0;border-style: none !important;" width="100%">
                            <tr>
                                <td width="2%"></td>
                                <td align="center" style="padding-top: 15px; ">
                                    <div style="width: 84%; position: absolute; z-index: 1; color: rgb(117, 117, 117); text-align: center; pointer-events: none; display: block;" ng-style="stylecheckintextincre">
                                        <span ng-if="flagcheck == 1">Hour</span>
                                        <span ng-if="flagcheck == 2">ชั่วโมง</span>
                                        <span ng-if="flagcheck == 3">小时</span>
                                    </div>
                    ...
                    <div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 5px;    border-radius: 0 0 10px 10px;" ng-if="state6[0].status_confirm == 0" ng-repeat="item in state6">
                        <table style=" border-color: #f0f0f0;border-style: none !important;" width="100%">
                            <tr>
                                <td width="2%"></td>
                                <td width="35">
...
<div id="commentmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 0">
      	<i class="back_close " ng-click="cancelopenopupcomenthome()" data-dismiss="modal">&#10006</i>
        <input type="hidden" name="vccomment" value="{{vccomment}}">
            ...
            <div class="" ng-if="getcommentviewhome.length == 0" style="padding: 3px 6px;
    border-radius: 8px;
    background: #fff;">    
            <div class="borderdetail-check">
             ...
             <div class="box-com-se">                    
                       <div style="font-size: 16px;"> 
                        <div class="btn btn-block btn-default" ng-click="updatecomment(vccomment)" ng-style="senddata" style="margin-top: 19px; padding: 12px !important;    display: block; background: #3b5998; color: #fff;" ng-if="getcommentviewhome.length == 0">
                            <i class="fa fa-paper-plane fa-lg " aria-hidden="true"></i>
                        </div>
                        <div class="btn btn-block btn-default" ng-click="Eupdatecomment()" ng-if="Ecomment" ng-dblclick="doubleClick()" style="margin-top: 19px; padding: 12px !important; display: block; background: #3b5998; color: #fff;">
                            <i class="fa fa-paper-plane fa-lg " aria-hidden="true"></i>
                        </div>
                    </div>
                </div>
						...
						<div class="box-in-comment" ng-repeat="item in getcommentviewhome" style="font-size: 16px;    padding-top: 7px;">
...
<div modal="showModal" class="box-bg44" ng-style="popupbookingdetail" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="top: 18%;">
		...
		<i class="back_close " ng-click="cancel()" data-dismiss="modal">&#10006</i>		
			<!-- <img src="images/cancel.png" ng-click="cancel()" align="center" class="modal_close" /> -->
			<div class="box-img-photo">
<div style="font-size: 18px; padding: 5px;" align="center">
					<div ng-if="flagcheck == 1"  >This order details</div>
	                <div ng-if="flagcheck == 2"  >ข้อมูลการจองนี้</div>
	                <div ng-if="flagcheck == 3"  >这订单详情</div>
					
   			  </div>
    			<div class="box-in-photo" style="height: 630px; border-radius: 0 0 8px 8px;	    overflow: hidden; overflow-y: scroll; margin-bottom: 5px;">
                ...
                <table style="font-size: 16px" width="100%">
                    ...
                    <tr>
                      ...
                      <td >
                          <span >
                            <i  class="fa fa-user " aria-hidden="true" style="margin-right: 10px;color: #3b5998;font-size: 20px;"></i>{{posted}} 
                        </span>
                    ...
                    <tr >
                      ...
                      <td></td>
                      <td>
                          <span ><i  class="fa fa-user" aria-hidden="true" style="margin-right: 10px;color: #3b5998;font-size: 20px;"></i>{{user_confirm}}
                          </span>
                      </td>
                      <td></td>
                      <td align="center" style="text-align: center;">
...
<div modal="showModal" class="box-bg44" ng-style="popupdriverdetail" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="top:18%">
		...
		<!-- <i class="back_close fa fa-angle-left"  class=""></i> -->
			<!-- <img src="images/cancel.png" ng-click="cancelpopupdriverdetail()" align="center" class="modal_close" /> -->
			<div class="box-img-photo" >
			<div align="center" style="font-size: 18px; padding: 10px">
				<img src="images/car-detail.png" width="25" >
				...
				<div class="box-in-photo" style="padding: 0 5px; overflow: hidden;    overflow-y: scroll;">
...
<div modal="showModal" class="box-bg26" ng-style="stylepoupmyinfo" id="bg-modal">
	<div class="box-modal-top-50-lg box-modal-top-50-md box-modal-top-50-sm" style="top: 18%">
		<div class="modal-body" id="body-photo" style="padding: 0">
		<i class="back_close " ng-click="cancelstylepoupmyinfo()" data-dismiss="modal">&#10006</i>	
			<div class="box-img-photo">
				<div style="font-size: 18px;padding: 5px" align="center">
					<i class="fa  fa fa-users " style="font-size:28px;color: #3b5998; "  ></i>
					<span ng-if="flagcheck == 1">My information</span>
					<span ng-if="flagcheck == 2">ข้อมูลของฉัน</span>
			            ...
			            <table width="100%">
			                <tr ng-repeat="item in socialall" style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}">
			                    ...
			                    <td >
			                        ...
			                        <i ng-click="editfunsocial(item)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true"></i>
			                    </td>
			                    <td width="10"></td>
...
<div id="attractiondrivermodal_toop" class="modal fade" role="dialog">
  	<div class="modal-dialog">
	    <div class="modal-content">
      		...
      		<input type="hidden" name="" value="{{VCID}}" ng-model="VCID">
        		...
        		<div align="center" style="font-size: 18px;margin-bottom: 0; padding: 10px;background-color: #fff;border-radius: 8px 8px 0 0;">
						<img src="img/attraction.png?v=<?=$cache;?>" width="20" align="absmiddle">
						<span ng-if="flagcheck == 1" style="font-size: 18px;">Attractions</span>
						<span ng-if="flagcheck == 2" style="font-size: 18px;">แหล่งท่องเที่ยว </span>
						<span ng-if="flagcheck == 3" style="font-size: 18px;">景点</span>
						<img src="images/arrow-r.png?v=<?=$cache;?>" width="20" style="display: inline-block;" >
					...
					<div style="background: #f0f0f0;font-size: 18px;margin-bottom: 0;padding: 5px;border-radius: 0 0 8px 8px">
						<table width="100%" style="margin-top: 10px;margin-bottom: 10px;">
					   		<tr>
					   			<td width="10"></td>
					   			<td align="left" >
					   				<div style="float: left; padding: 9px 12px; background: #3b5998;    text-shadow: none; border-radius: 8px; color: #fff;outline: none;" ng-click="btnattractionopmodal()" ng-style="btnfreattraction_toop">
					   					<span ng-if="flagcheck == 1">Frequently used</span>
					   					<span ng-if="flagcheck == 2">ข้อความที่ใช้บ่อย</span>
					   					<span ng-if="flagcheck == 3">常用信息</span>
					   				</div>
					   			...
					   			<td width="10"></td>
					   			<td align="center">
					   				<div style="padding: 9px 12px; background: #3b5998; text-shadow: none;    border-radius: 8px; color: #fff;outline: none;" ng-click="btnMessageattractionopmodal()" ng-style="btnchatattraction_toop">
					   					<span ng-if="flagcheck == 1">Chat</span>
					   					<span ng-if="flagcheck == 2">แชท</span>
					   					<span ng-if="flagcheck == 3">聊</span>
					   				</div>
					   ...
					   <div style="padding: 5px 9px;display: none;" ng-style="frequentlyusedattraction_toop" >
						   <div style="border: solid 2px #3b5998;height: 285px;border-radius: 8px;overflow: auto; display: block;margin-bottom: 11px;margin-top: 7px;" ng-style="sdatamessageattraction_toop" >
						   		<ul ng-repeat="item in messagedata" ng-class="{evenmesage: $even, oddmesage: $odd}" >
						   			<li ng-if="flagcheck == 1" ng-bind="$index+1+'.'+item.topic_en" ng-click="selectmessage(item)"></li>
						   			<li ng-if="flagcheck == 2" ng-bind="$index+1+'.'+item.topic_th" ng-click="selectmessage(item)"></li>
						   			<li ng-if="flagcheck == 3" ng-bind="$index+1+'.'+item.topic_cn" ng-click="selectmessage(item)"></li>
						   	...
						   	<div style="border: solid 2px #3b5998;height: 285px;border-radius: 8px;overflow: auto; display: none;margin-bottom: 11px;margin-top: 7px;" ng-style="sdatamessageattraction_store_toop" >
						   <!-- 	<div style="font-size: 17px;"><i class="fa fa-angle-left" ng-click="btnFrequentlyused()" style="padding: 10px 10px;"></i><span ng-bind="headersmessage"></span></div> -->
						   		<ul ng-repeat="item in messagedataStore" ng-class="{evenmesage: $even, oddmesage: $odd}" >
						   			<li ng-if="flagcheck == 1" ng-bind="$index+1+'.'+item.topic_en" ng-click="selectmessageattraction_store_toop(item)"></li>
						   			<li ng-if="flagcheck == 2" ng-bind="$index+1+'.'+item.topic_th" ng-click="selectmessageattraction_store_toop(item)"></li>
						   			<li ng-if="flagcheck == 3" ng-bind="$index+1+'.'+item.topic_cn" ng-click="selectmessageattraction_store_toop(item)"></li>
						   		</ul>
						   	</div>
						   	<div style="width: 100%;top: 420px;position: absolute;display: none;" align="center" ng-style="spintakechattodriverselect">
    						<i class="fa fa-spinner faa-spin animated " aria-hidden="true" style="color: #3b5998; font-size: 36px;"></i>
    						</div>
						   	<div ng-style="havedatamessageattraction_toop" align="center" style="margin-top: 15px;">
						   		<textarea class="form-control" rows="2" id="comment"  ng-style="" style="margin-bottom: 10px;border-radius: 8px; pointer-events: none;" value="{{SELmessage_store}}" ng-model="SELmessage_store"></textarea>
						   		<div class="btm-checkin" ng-click="confirm_sendmaildelay(29,VCID)" style="margin-top: 15px;" >
									<i class="fa fa-paper-plane fa-2x " aria-hidden="true" style="font-size: 18px;padding: 0 10px;"></i>
								</div>
							</div>
					   </div>
						...
						<div style="padding: 5px 9px;margin-top: 9px;" ng-style="messageattraction_toop">
							<textarea class="form-control" rows="5" id="comment" ng-model="comdriver" ng-change="YourOwnComments(comdriver)" ng-style="owncomments" style="margin-bottom: 10px;border-radius: 8px;"></textarea>
							<div class="btm-checkin" ng-click="confirm_sendmaildelay(5,VCID)" style="display: none;margin-top: 15px;" ng-style="confirmcommenttoderiver">
								<i class="fa fa-paper-plane fa-2x " aria-hidden="true" style="font-size: 18px;padding: 0 10px;"></i>
							</div>
