			...
			<tr >
				...
				<td width="10%" >
					<div class="logoagent" data-toggle="modal" data-target="#upphotobycompany">
						<img ng-src="{{TB_order_agent}}.jpg" err-src="images/ctr.jpg" width="40" height="40" ng-click="snapphoto()">
					</div>
				</td>
				<td align="center" >
				...
				<td width="10%" align="right">
					<div class="dropdown-toggle" aria-hidden="true"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<i class=" fa fa-cog fa-lg "  style="font-size: 28px; color: #fff;line-height: 1;"></i> 
					</div>
					<ul class="dropdown-menu" style="right: 0;color: #555;font-size: 16px" >
								...
								<div style="margin-top: 10px;" >
									<table width="100%" style="font-size: 17px;color: rgba(97, 97, 97, 0.84);" >
										...
										<td align="center" style="padding-top: 8px;padding: 14px 0px;" width="20%" ng-click="getbookinfomation(x)">							
											...
											<td width="20%" align="center" style="padding-top: 8px;padding: 14px 0px;"  ng-disabled="x.datessnew ==2" ng-click="openpopupdriverinfo(x);openpopuptodriver(x.TB_order_order)" data-toggle="modal" data-target="#myModal">
												...
												<img src="images/driver.png?v=<?=$cache;?>" width="35" align="absmiddle"><Br/>
													...
													<span class="length-statehomereddriver" ng-if="i.count_driver != '0' && i.invoice == x.TB_order_order" ng-repeat="i in nontifigcomment">
														<span ng-bind=" i.count_driver" ></span>
													</span>
										...
										<tr>
											...
											<td width="20%" align="center" style="padding-top: 8px;padding: 14px 0px;" ng-disabled="x.datessnew ==2"  ng-click="openpopupdriverOP(x)">
											...
											<td width="20%" align="center" style="padding-top: 8px;padding: 14px 0px;" ng-click="openpopupdriverservice(x)" ng-disabled="x.datessnew ==2">
												<img src="images/pluss.png?v=<?=$cache;?>" width="35" align="absmiddle" style="margin-top:-5px "><Br/>
												<span ng-if="flagcheck == 1">Service</span>

                                            <span ng-if="flagcheck == 2"  >บริการ</span>
