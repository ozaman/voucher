...
<div data-role="page" id="home">
  ...
  <!--   <div class="header" data-role="header" style="position: fixed;">
        <div>
            <p id="namedriver" style="font-size: 18px;padding-top: 25px;" align="center">
            {{TB_admin_companyhome}}
        
            </p>
            <div class="logoagent" style=" margin-top: -35px;margin-right: 11px;">
            <img ng-src="http://www.t-booking.com/v1/admin/file/logo/crop/{{agenthome}}.jpg" err-src="images/ctr.jpg" width="45" height="40" ng-click="snapphoto()">
        </div>
        
        </div>
        
        <a href="#home" class="home-icon home-no" data-transition="slide">
            <i class="fa fa-home fa-2x" aria-hidden="true" style="font-size: 40px;margin-top: -8px;" style="font-size: 40px; margin-top: -8px;"></i>
         </a>
    ...
    text-align: center; border-radius: 60px; margin-left: 87%; margin-top: 68px;  z-index: 60;    color: #3399CC; font-size: 16px;margin-top: 60px; box-shadow: 1px 1px 5px #999999;    
    background: #fff;">
    ...
    <div slass="sec-titlehome" style="width: 100%;
    padding: 10px 0;
    margin-top: 50px;
    background: #cae2ef;
    ...
    color: #000;position: fixed;">
        <p style="width: 100%;display: block;margin: 0;" align="center">
    ...
    <div class="ui-content" style="">
           ...
           <!-- CHECK ID order  -->
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0" ng-repeat="x in voucherselect" >
                <tr><td>
                
                <a href="#voucher" id="listitemhome" data-transition="slide" ng-click="getvoucher(x.TB_order_order)" style="text-decoration:none !important">
               <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
                 ...
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <!-- <tr >
                    ...
                    <td width="10"  class="{{x.styletabelhead}}" style="border-radius: 8px 0 0 0;border-bottom-left-radius: 8px;">&nbsp;</td>
                    <td align="center" class="{{x.styletabelhead}}" style="font-size: 20px" >
                         <span ng-if="flagcheck == 1" >Use date</span>
                         <span ng-if="flagcheck == 2">ใช้วันที่</span>
                         <span ng-if="flagcheck == 3" >使用日期</span>
                    </td>
                    <td width="0"  class="{{x.styletabelhead}}">&nbsp;</td>
                    <td align="center"  class="{{x.styletabelhead}}" style="font-size: 20px" style="border-bottom-right-radius: 8px;">
                        <span ng-if="flagcheck == 1" >time</span>
                        <span ng-if="flagcheck == 2" >เวลา</span>
                        <span ng-if="flagcheck == 3" >时间</span>
                    </td>
                    <td width="10"  class="{{x.styletabelhead}}" style="border-bottom-right-radius: 8px;border-top-right-radius: 8px;">&nbsp;</td>
                  </tr> -->
                  <tr >
               ...
               <tr ><td colspan="7" style="border-bottom:1px solid #ddd; height:8px "></td>
               </tr>
             </table>
             </a>
                        ...
                        <!-- <p style="display: block;font-size: 13px;margin-left: 90px;font-weight: 400">
                            <p style="margin-left: 90px;width: 93% "">
                                <span ng-if="flagcheck == 1" style="font-size: 21px;font-weight: 400">Use the date / time</span>
                                <span ng-if="flagcheck == 2" style="font-size: 21px;font-weight: 400">ใช้วันที่ / เวลา</span>
                                <span ng-if="flagcheck == 3" style="font-size: 21px;font-weight: 400">使用日期／时间</span>



                            </p>
                            <P style="margin-left: 90px;font-weight: 400;font-size: 21px; ">
                                <span>{{x.TB_order_outdate}}</span>&nbsp;/
                                <span>{{x.airout_h}}-{{x.airout_m}}</span>
                                <!-- <span>{{x.datessnew}}</span> 
                            </P>
                           <!--  <i class="fa fa-clock-o" aria-hidden="true"></i> 
                            
                        </p> 
                         
                        <!-- <p style="display: block;font-size: 13px;margin-left: 90px; width: 93% ">
                           <span countdown='' date='Nov 27 2016 12:00:00'>&nbsp;</span>
                        </p>  -->
                        <!-- <span class="topic-page">{{x.TB_order_order}}</span> -->
...
<!-- voucher -->
<div data-role="page" id="voucher" style="background: #fff">
 <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
      <table width="100%">
         <tr >
            <td width="3%"></td>
...
<div data-role="page" id="Guest-detail" style="background: #fff">
 <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">    
    <table width="100%">
    ...
    <div style="border-radius: 8px;background-color: #cae2ef;margin-top: 80px;">
      <table width="100%">
          <tr >
              ...
              <td align="right">
                    <i class="fa fa-share-square-o fa-2x" aria-hidden="true" ng-click="sharesocial()" style="color: #3C8DBC; font-size: 25px; z-index: 61;"></i> 
              </td>
              <td width="3%" style="border-radius: 0 0 8px 0;"></td>
         </tr>
      </table>
...
<div data-role="page" id="Booking-information" style="background: #fff">
    <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
...
<div data-role="page" id="Driver" style="background: #fff">
    <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
...
<div data-role="page" id="Place" style="background: #fff">
      <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
      <table width="100%">
        ...
        <div class="col" style="">    
            <div class="borderdetail" >
                ...
                <div class="textdetail3">
                    ...
                    <li>
                        <span  ng-if="flagcheck == 1" style="color: #539bc5;" >On Date / Time : </span>
                        <span  ng-if="flagcheck == 2" style="color: #539bc5;" >วันที่ใช้บริการ / เวลา :</span>
                        <span  ng-if="flagcheck == 3" style="color: #539bc5;" >使用日期 / 时间 : </span>
                        <span style="float: right;font-weight: normal !important;" ng-bind="outdate"> / <span style="font-weight: normal !important" ng-bind="airout"></span></span>
                    ...
                    <li  ng-click="popupselecttitleinform()">
                ...
                <div align="center" style="font-size: 18px;    padding: 12px 0;">
                ...
                <table id="record" width="100%" style="margin-bottom: 10px;font-size: 16px" ><!-- <span ng-class="{evendelay: $even, odddelay: $odd}"></span> -->
                    ...
                    <tr style="background-color: #DDD;">
                        <td width="20%" style="padding: 8px 0;border-radius: 8px 0 0 0;" align="center">
                           <div class="box-index-rec">{{$index+1}}</div>
                           <i class="fa fa-user fa-lg" aria-hidden="true" style="margin-left: 5px"></i>
                        </td>
                        <td width="2%"></td>
                        <td width="20%" >
                        ...
                        <td width="2%"></td>
                        <td width="" colspan="4" style="border-radius: 0 8px 0 0;">
                    ...
                    <tr ng-if="item.state == 1" style="    background: #f0f0f0;">
                        ...
                        <td></td>
                        <td >{{item.flight_delay }}</td>

                    </tr>
                    <tr ng-if="item.state == 1" style="    background: #f0f0f0;">
                      <td colspan="3" style="padding: 8px 0; border-radius: 8px 0 0 0;">
                          <span ng-if="flagcheck == 1">Time record</span>
                            <span ng-if="flagcheck == 2">บันทึกเวลา</span>
                            <span ng-if="flagcheck == 3">时间记录</span>
                      </td>
                      <td></td>
                      <td colspan="2">
                    ...
                    <tr ng-if="item.state == 3" style="    background: #f0f0f0;">
                        ...
                        <td></td>
                        <td align="center"><span><img ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{item.img_post_date}}.jpg" width="28" height="28" ng-click="showimages1(item)" ng-show="item.img_post_date != '' && item.img_post_date != undefined" style="border-radius: 8px;"></span></td>
                ...
                <!-- <ul class="record-main-ul">
                    <li  ng-class="{evendelay: $even, odddelay: $odd}">
                        <div style="padding-top: 17px; font-size: 16px !important;    line-height: .8;padding-left: 8px; padding-right: 8px;">
                         
                            <div ng-if="item.state == 1" style="display: inline-block;width: 82px;">
                                <span ng-if="flagcheck == 1">Delay :</span>
                                <span ng-if="flagcheck == 2">ล่าช้า :</span>
                                <span ng-if="flagcheck == 3">延遲 :</span>
                            </div>
                            <div ng-if="item.state == 3" style="display: inline-block;width: 82px; ">
                                <span ng-if="flagcheck == 1" style="width: width: 125px;">Waiting :</span>
                                <span ng-if="flagcheck == 2">รออยู่แล้ว :</span>
                                <span ng-if="flagcheck == 3">已经在等 :</span>
                            </div>
                            <div ng-if="item.state == 0" style="display: inline-block;width: 82px;">
                                <span  ng-if="flagcheck == 1">Not delay :</span>
                                <span  ng-if="flagcheck == 2">ไม่ล่าช้า :</span>
                                <span  ng-if="flagcheck == 3">不延遲 :</span>
                            </div>
                            
                            
                            <div ng-if="item.state == 1" style="margin-left:3%;display: inline-block;" >
                                <span>{{item.flight_delay }}</span>
                        </div>
                         <div ng-if="item.state != 1" style="width: 12%;  display: inline-block; margin-left: 11px; " >
                                <span ng-if="flagcheck == 1">No</span>
                                <span ng-if="flagcheck == 2">ไม่มี</span>
                                <span ng-if="flagcheck == 3">沒有</span>
                        </div>
                        <div style="float: right;  padding: 0;" ng-if="item.state != 2 && item.guest_topoint_date != ''">
                            <span>{{item.flight_delay_date*1000 | date:' yyyy-MM-dd / HH:mm' }}</span>
                        </div>
                        
                        <Br/>
                        <Br/>
                        <div ng-if="guest_topoint == 1">
                             <a>   
                                <img src="https://goldenbeachgroup.com/app/car/images/icon_map/map_pin.png">
                                <span ng-click="Checkinguest()">
                                    <span ng-if="flagcheck == 1">View map :</span>
                                    <span ng-if="flagcheck == 2">ดูแผนที่ :</span>
                                    <span ng-if="flagcheck == 3">查看地圖 :</span>
                                </span>
                                <p style="display: inline-block;margin-bottom: 0;">{{item.guest}}</p>
                                </a>
                                <span style="margin-left: 3%;  padding: 0;">
                            <img ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{item.img_post_date}}.jpg" width="25" height="25" ng-click="showimages1(item.img_post_date)" ng-show="item.img_post_date != '' && item.img_post_date != undefined" style="margin-right: 10px;margin-left: 5px;">
                            <img ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{item.yourself_post_date}}.jpg" width="25" height="25" ng-click="showimages2(item.yourself_post_date)" ng-show="item.yourself_post_date != '' && item.yourself_post_date != undefined">
                        </span>
                            </div>
                            <Br/>
                        
                        <span id="ico-ri" ng-if="guest_topoint == 0"><i class="fa fa-times fa-lg" style="color: #a8211a" aria-hidden="true"></i></span>
...
<div data-role="page" id="Recomment" style="background: #fff">
    <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
...
<div data-role="page" id="Comment" style="background: #fff">
    <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
...
<div data-role="page" id="increasetime" style="background: #fff">
    <div class="header" style="position: fixed;font-size: 16px;z-index: 1;">
    <table width="100%">
              ...
              <div align="center" style="font-size: 18px;padding: 8px;">
                ...
                <table id="record" width="100%" style="margin-bottom: 10px;font-size: 16px" ><!-- <span ng-class="{evendelay: $even, odddelay: $odd}"></span> -->
                    ...
                    <tr style="background-color: #cae2ef;">
                        ...
                        <td width="20%" >
                          ...
                          <div ng-if="itemmap.comment_from == 'DRIVER'">
                              <span ng-if="flagcheck == 1">Driver</span> 
                              <span ng-if="flagcheck == 2">คนขับรถ</span> 
                              <span ng-if="flagcheck == 3">司机</span> 
                          </div>
                          <div ng-if="itemmap.comment_from == 'CALL CENTER'">
                              <span ng-if="flagcheck == 1">Call center</span> 
                              <span ng-if="flagcheck == 2">คนขับรถ</span> 
                              <span ng-if="flagcheck == 3">ศูนย์รับแจ้ง</span> 
                          </div>
                        ...
                        <!-- <td align="center" style="border-radius: 0 8px 0 0;"><span ng-if="item.state==3"><img ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{item.yourself_post_date}}.jpg" width="28" height="28" ng-click="showimages2(item.yourself_post_date)" ng-show="item.yourself_post_date != '' && item.yourself_post_date != undefined" style="border-radius: 8px;"></span></td> -->
                        
                    </tr>
                    <!-- ========= STATE !======== -->
                    <tr ng-if="itemmap.state == 1" style="    background: #ddd;">
                        <td align="center" style="padding: 8px 0;">
                            <i class="fa fa-exclamation fa-lg" aria-hidden="true"></i>
                        </td>
                        <td></td>
                        ...
                        <td></td>
                        <td >{{itemmap.flight_delay }}</td>

                    </tr>
                    <tr ng-if="itemmap.state == 1" style="    background: #ddd;">
                      <td colspan="3" style="padding: 8px 0;border-radius: 0 0 0 8px;    padding-left: 5px;">
                          <span ng-if="flagcheck == 1">Time record</span>
                            <span ng-if="flagcheck == 2">บันทึกเวลา</span>
                            <span ng-if="flagcheck == 3">时间记录</span>
                      </td>
                      ...
                      <td colspan="2" align="right" style="border-radius: 0 0 8px 0;">
                          <!-- <img src="https://goldenbeachgroup.com/car/images/icon/view/map.png" ng-click="Pickupplace()" width="30"> -->
                      </td>
                    </tr>
                    <!-- ================STATE 3 ============= -->
                    <tr ng-if="itemmap.state == 3" style="    background: #ddd;">
                        <td align="center" style="padding: 8px 0;">
                            <i class="fa fa-exclamation fa-lg" aria-hidden="true"></i>
                        </td>
                        <td></td>
                    ...
                    <tr ng-if="itemmap.state == 3" style="    background: #ddd;">
                      ...
                      <td></td>
                      <td colspan="3" style="border-radius: 0 0 8px 0;">
                          <span>{{itemmap.flight_delay_date*1000 | date:' yyyy-MM-dd / HH:mm' }}</span>
                      </td>
                      <!-- <td colspan="2" align="right" >
                          <img src="https://goldenbeachgroup.com/car/images/icon/view/map.png" ng-click="Pickupplace()" width="30">
                    ...
                    <!-- ================STATE 2 ============= -->
                    <tr ng-if="itemmap.state == 2" style="    background: #ddd;">
                        <td align="center" style="padding: 8px 0;">
    ...
    position: fixed;" />
            <div class="box-img-photo">
              <p style="font-size: 18px;padding-top: 10px; padding-left: 10px;" align="left">
                ...
                <img align="center" ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{imagesselet}}.jpg" err-src="images/im.png" width="100%" height="100%" style="padding: 5px; background: #cae2ef;border-radius: 0 0 10px 10px;height: 234px;">
                <Br/>
              </div>
              <p style="font-size: 18px;padding-top: 10px; padding-left: 10px;" align="left">
                    <B ng-if="flagcheck == 1 || flagcheck == 2">2. </B>
                ...
                <img align="center" ng-src="http://t-booking.com/web/v1/PHP/fileUpload/{{imagesselet2}}.jpg" err-src="images/im.png" width="100%" height="100%" style="padding: 5px; background: #cae2ef;border-radius: 0 0 10px 10px;height: 234px;">
                        ...
                        <div ng-style="selectdelayradio" style="display: none;">
                            <div class="bradio" style="padding-left: 0;font-size: 18px">
                                <label ng-click="Delay(1)" style="margin: 0"><input type="radio" name="chickenEgg3"  id="checked2"  style="margin-top: 0;">
                                    <p  ng-if="flagcheck == 1">Request to delay time</p>
                                    <p  ng-if="flagcheck == 2">ขอเลื่อนเวลา</p>
                                    <p  ng-if="flagcheck == 3">要求延期使用时间</p>
                                </label>
                            </div>
                            <div class="bradio" style="padding-left: 0;font-size: 18px">
                        ...
                        <table ng-style="timedelay" style="display: none;border-color: #cae2ef;border-style: none !important  " border="1">
                            <tr>
                                <td colspan="5" align="center">
                                    <span  ng-if="flagcheck == 1">Delay</span>
                                    <span  ng-if="flagcheck == 2">ล่าช้า</span>
                                    <span  ng-if="flagcheck == 3">延迟</span>
                                </td>
                            </tr>
                            <tr>
                                <td width="2%"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="padding-top: 20px;">
                                    ...
                                    <div class="btm-checkin" ng-style="stylecheckin" ng-click="confirm_sendmaildelay(1)">
