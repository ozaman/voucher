    ...
    <div class="modal-dialog">
      	<div class="modal-content">
	        <div class="modal-body" style="padding: 0;">
				...
				<div class="Edit{{item.id}}"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
					...
					<div class="Edit{{idface}}"  style="background: #f0f0f0;font-size: 18px; margin-bottom: 0; padding-bottom: 16px; border-radius: 0 0 8px 8px;padding-top: 20px;display: none">
                        
						<table  width="100%">
							<tr >
								<td width="4%"></td>
								<td>
									<img src="images/social/{{iconface}}" style="width: 50px; border-radius: 10px; height: 50px;">
								</td>
								<td width="5%"></td>
								<td>
    ...
    <div class="modal-dialog" style="margin: 0;margin-top: -3px;" id="popupbookingdetailm">
	      ...
	      <div class="modal-content">
	        <div class="modal-body" style="padding-top: 0" >
	            ...
	            <div ng-click="detailfirsthomein(VOUCHER)" data-toggle="modal" data-target="#popupdriverdetail" style="padding: 2px 10px;" ng-if="typeTour == 'transfer'&& checkDriver != null && checkDriver != ''">
	                <table width="100%" style="margin-bottom: 5px; color: #fff; border-radius: 8px;    background: #3b5998;">
						<tr>                                 
							<td align="center" style=" padding: 5px 0; " width="60">
								<div  style="position: relative;border: 0px solid #999999; width: 30px; height: 30px; text-align: center;    border-radius: 60px; margin-left: 2%;    color: #3b5998; background: #fff;    box-shadow: 1px 1px 5px #999999;">
                ...
                <div style="font-size: 16px;background:#f0f0f0;border-bottom: 1px solid #ddd;    text-align: center;" ng-if="typeTour == 'transfer'">
                ...
                <table style="font-size: 16px" width="100%" ng-if="typeTour == 'transfer'">
                    ...
                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;" ng-if="area != 'In'">
                      ...
                      <td></td>
                      <td>
                          <span ng-if="room_number.length == 0"><input type="text" class="form-control" name="roomnum" ng-model="roomnum" ng-change="inputroomnumber(roomnum)"></span>
                ...
                <!-- TYPE TOUR -->
	                ...
	                <table style="font-size: 16px" width="100%" ng-if="typeTour != 'transfer'" ng-repeat="item in dataVoucher">
	                    ...
	                    <tr style="background:#fff;border-bottom: 1px solid #ddd;">
	                      ...
	                      <td></td>
	                      <td>
                          <span ng-if="item.room_number.length == 0"><input type="text" class="form-control" name="roomnum" ng-model="roomnum" ng-change="inputroomnumber(roomnum)"></span>
                      ...
                      <td align="center">
	                    ...
	                    <tr style="background:#f0f0f0;border-bottom: 1px solid #ddd;">
	                        ...
	                        <td >
	                            ...
	                            <span ng-if="flagcheck == 2" ng-bind="item.tb_web_admin_company"></span>
	                            <span ng-if="flagcheck == 3" ng-bind="item.tb_web_admin_company"></span>
	        	...
	        	<div style="padding:3px 2px; background: #fff; border-radius: 8px;">
			            ...
			            <table width="100%" >
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwechatid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idwechatnull,iconwechatnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="sociallineid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idlinenull,iconlinenull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}"  ng-if="socialqqid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idqqnull,iconqqnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialskypeid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idskypenull,iconskypenull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwangid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idwangnull,iconwangnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialwhatid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idwhatnull,iconwhatnull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
			                ...
			                <tr  style="border-bottom: 1px solid #ddd;" class="seecolor{{$index}}" ng-if="socialzelloid == ''">
			                    ...
			                    <td >
			                        <span ng-bind="item.web_guest_social"></span>
			                        <i ng-click="editfunsocialnull(idzellonull,iconzellonull)" class="fa fa-pencil-square-o fa-lg pull-right" style="font-size: 30px; color: #3b5998; margin-top: 2px; right: 0; display: inline-block; " aria-hidden="true" data-toggle="modal" data-target="#editsocialall"></i>
			                    </td>
			                    <td width="10"></td>
